...
class Manufacturer extends CI_Controller {
    ...
    public function index(){
       $data = array();
        ...
        $data['main_content'] = $this->load->view('purchase/manufacturer/add', $data, TRUE);
        $this->load->view('purchase/manufacturer/add', $data);
    ...
    {   
        if ($_POST) {
           ...
           redirect(base_url('purchase/manufacturer/all_manufacturer_list')); 
        }
    }
...
<?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'purchase/manufacturer/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                ...
                <button type="button" class="form-control" href="<?php echo base_url();?>purchase/manufacturer/all_manufacturer_list">Cancel</button>
    ...
    {   
        ...
        $this->load->view('purchase/manufacturer/manufacturers', $result);
