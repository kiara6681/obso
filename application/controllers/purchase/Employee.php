...
class Employee extends CI_Controller {
   ...
   public function index(){
      ...
      $data['main_content'] = $this->load->view('purchase/employee/add', $data, TRUE);
      $this->load->view('purchase/employee/add', $data);
      ...
      if ($_POST) {
         ...
         if(!empty($return)){
            ...
            if($this->email->send()){
               ...
               redirect(base_url('purchase/employee/all_employee_list'));       
            }else{
   ...
   public function update($id="")
   {
      ...
      <?php echo form_open(base_url() . 'purchase/employee/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
   ...
   {   
      ...
      $this->load->view('purchase/layout/header');
      $this->load->view('purchase/layout/footer');
      $this->load->view('purchase/employee/employee', $result);
   }
