...
class Sales extends CI_Controller {
    ...
    public function customer_list(){
        ...
        $this->load->view('purchase/sales/customer_list', $data);
    ...
    public function delete_customer_list($id)
    {
        ...
        redirect(base_url('purchase/sales/customer_list'));
    }
    ...
    public function prospects(){
        ...
        $data['page_title'] = 'Prospects';
         $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/sales/prospects', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    public function account(){
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/sales/account', $data);
        $this->load->view('purchase/layout/footer', $data);
    ...
    public function customer_records(){
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/sales/sales_header', $data);
        $this->load->view('purchase/sales/customer_records', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    {   
        ...
        if ($_POST) {
           ...
           //       $this->load->view('purchase/sales/customer_records', $this->session->all_userdata());
           //  $this->load->view('purchase/sales/edit_customer_records', $data);
           // redirect(base_url('purchase/sales/customer_contact')); 
    ...
    {        
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/sales/sales_header', $data);
        $this->load->view('purchase/sales/edit_customer_contacts', $data); 
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    public function customer_contact(){
        ...
        $this->load->view('purchase/sales/customer_contact', $result);
    ...
    public function update_customer_contact($id="")
    {
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/sales/sales_header', $data);
        $this->load->view('purchase/sales/edit_customer_contact', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    public function update_customer_contactss($id="")
    {
        ...
        $this->common_model->update($data, $customer_contact_id,'customer_contact');
        $this->session->set_flashdata('msg', 'Customer Contact Updated Successfully');
        redirect(base_url('purchase/sales/edit_customer_contacts/'.$sessionid));
        }
    ...
    public function update_customer_contacts($id="")
    {
        ...
        $this->common_model->update($data, $customer_contact_id,'customer_contact');
        $this->session->set_flashdata('msg', 'Customer Contact Updated Successfully');
        redirect(base_url('purchase/sales/edit_customer_contacts/'));
        }
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/sales/sales_header', $data);
        $this->load->view('purchase/sales/edit_customer_contactss', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    $data = array(
         ...
         $this->common_model->update($data, $id,'customer_records');
        redirect(base_url('purchase/sales/prospects'));
    }
