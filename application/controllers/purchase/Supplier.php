...
class supplier extends CI_Controller {
    ...
    public function delete_supplier_list($id)
    {
        ...
        redirect(base_url('purchase/supplier/supplier_list'));
    }
    ...
    public function prospects(){
        ...
        $this->load->view('purchase/supplier/prospects', $data);
    ...
    public function partner(){
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/supplier/partner', $data);
        $this->load->view('purchase/layout/footer', $data);
    ...
    public function supplier_records(){
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/supplier/supplier_header', $data);
        $this->load->view('purchase/supplier/supplier_records', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    {       
        ...
        if ($_POST) {
            ...
            $this->load->view('purchase/supplier/supplier_records', $this->session->all_userdata());
            $this->load->view('purchase/supplier/edit_supplier_records', $data);
           redirect(base_url('purchase/supplier/supplier_contact')); 
        }
    }
     ...
     public function supplier_list(){
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/supplier/supplier_list', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    public function update_supplier_contactss($id="")
    {
        ...
        redirect(base_url('purchase/supplier/edit_supplier_contacts/'.$sessionid));
        }
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/supplier/supplier_header', $data);
        $this->load->view('purchase/supplier/edit_supplier_contact', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
     ...
     public function update_supplier_contacts($id="")
    {
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/supplier/supplier_header', $data);
        $this->load->view('purchase/supplier/edit_supplier_contactss', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    public function edit_supplier_contacts($id="")
    {
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/supplier/supplier_header', $data);
        $this->load->view('purchase/supplier/edit_supplier_contacts', $data); 
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    /*Start supplier Contact*/
     ...
     public function supplier_contact(){
        ...
        $this->load->view('purchase/supplier/supplier_contact', $result);
    ...
    public function update_supplier_contactone($id="")
    {
        ...
        $this->load->view('purchase/layout/header', $data);
        $this->load->view('purchase/supplier/supplier_header', $data);
        $this->load->view('purchase/supplier/edit_supplier_contactone', $data);
        $this->load->view('purchase/layout/footer', $data);
    }
    ...
    $data = array(
        ...
        redirect(base_url('purchase/supplier/prospects'));
    }
