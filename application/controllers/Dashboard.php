...
class Dashboard extends CI_Controller {
   ...
   {  
      if ($_POST) {
         ...
         if(!empty($return)){
            ...
            $message = "Hello ".$data['email']." <br> Here is your password ".$password." for login into <a href='".base_url()."/admin/verify?q=".$data['verify_string']."'> ".base_url()." </a> <br> Click on the link below <br> <a href='".base_url()."admin/verify?q=".$data['verify_string']."'> Click Here </a>" ;
   ...
   {  
      $result['page_title'] = 'Employee List'; 
