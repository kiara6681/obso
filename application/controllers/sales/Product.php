...
public function __construct(){
    ...
    public function index(){
       $data = array();
        ...
        $data['main_content'] = $this->load->view('sales/product/add', $data, TRUE);
        $this->load->view('sales/product/add', $data);
    ...
    {   
        ...
        if ($_POST) {
         ...
         $data = array(
            ...
            redirect(base_url('sales/product/all_product_list')); 
...
<?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'sales/product/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<input type="hidden" name="maineditid" class="form-control" required data-parsley-maxlength="6" placeholder="Part No." value="<?php echo $edtdata->id; ?>"/>
    ...
    {   
        ...
        $this->load->view('sales/product/product', $result);
    }
