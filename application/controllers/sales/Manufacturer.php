...
class Manufacturer extends CI_Controller {
    ...
    public function index(){
       $data = array();
        ...
        $data['main_content'] = $this->load->view('sales/manufacturer/add', $data, TRUE);
        $this->load->view('sales/manufacturer/add', $data);
    ...
    {   
        if ($_POST) {
           ...
           redirect(base_url('sales/manufacturer/all_manufacturer_list')); 
        }
    }
...
<?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'sales/manufacturer/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
    ...
    {   
        ...
        $this->load->view('sales/manufacturer/manufacturers', $result);
