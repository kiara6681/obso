...
class User extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['main_content'] = $this->load->view('sales/user/add', $data, TRUE);
    ...
    public function all_user_list()
    {
        ...
        $data['main_content'] = $this->load->view('sales/user/users', $data, TRUE);
        $this->load->view('sales/index', $data);
    }
    ...
    public function update($id)
    {
        ...
        $data['country'] = $this->common_model->select('country');
        $data['main_content'] = $this->load->view('sales/user/edit_user', $data, TRUE);
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('sales/user/user_power', $data, TRUE);
        $this->load->view('sales/index', $data);
    }
    ...
    {   
        if (isset($_POST)) {
            ...
            redirect(base_url('sales/user/power'));
        }
