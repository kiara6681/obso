...
class Manufacturer extends CI_Controller {
    ...
    public function index(){
       $data = array();
        ...
        $data['main_content'] = $this->load->view('admin/manufacturer/add', $data, TRUE);
    ...
    {   
        if ($_POST) {
           ...
           redirect(base_url('admin/manufacturer/all_manufacturer_list')); 
        }
    }
...
<?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'admin/manufacturer/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
    ...
    {   
        ...
        $result['data'] = $data = $this->common_model->get_all_manufacturer();
        $this->load->view('admin/layout/header', $result);
        $this->load->view('admin/layout/footer', $result);
        $this->load->view('admin/manufacturer/manufacturers', $result);
    ...
    public function updateFeature()
    {
        ...
        // Update Feature 
        $update = $this->common_model->updateFeature($id, $status);
