...
class supplier extends CI_Controller {
    ...
    public function prospects(){
        ...
        $this->load->view('admin/supplier/prospects', $data);
    ...
    public function partner(){
        ...
        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/supplier/partner', $data);
        $this->load->view('admin/layout/footer', $data);
    ...
    public function supplier_records(){
        ...
        $data['manufacturer']=$this->common_model->get_all_manufacturer();
            ...
            unset($_SESSION['lifecycle_status']);
        ...
        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/supplier/supplier_header', $data);
        $this->load->view('admin/supplier/supplier_records', $data);
        $this->load->view('admin/layout/footer', $data);
    }
    ...
    {       
        ...
        if ($_POST) {
            ...
            if($productcondition !=""){
            $product_condition = implode(',', array_values($productcondition));
            }else{
                $product_condition ="";
            }

            $lifecyclestatus = $_POST['lifecycle_status'];
            if($lifecyclestatus !=""){
            $lifecycle_status = implode(',', array_values($lifecyclestatus));
            }else{
              $lifecycle_status = "";  
            }
            ...
            $this->load->view('admin/supplier/supplier_records', $this->session->all_userdata());
            $this->load->view('admin/supplier/edit_supplier_records', $data);
           redirect(base_url('admin/supplier/supplier_contact')); 
        }
    }
    ...
    public function edit_supplier_records($id="")
    {
        if ($_POST) {
            ...
            $product_condition = implode(',', array_values($product_condition));

            $lifecycle_status = $_POST['lifecycle_status'];
            $lifecycle_status = implode(',', array_values($lifecycle_status));
        ...
        $data['industry']=$this->common_model->get_all_industry();
        $data['manufacturer']=$this->common_model->get_all_manufacturer();
        $data['productcondition']=$this->common_model->get_all_productcondition();
    ...
    public function edit_supplier_recordsone($id="")
    {   
        ...
        $this->session->set_flashdata('msg', 'Supplier Records Updated Successfully');
         ...
         redirect(base_url('admin/supplier/edit_supplier_recordsone/'.$sessionid));
        }
       ...
       // $data['page_title']='Edit supplier Contact';
        ...
        $this->load->view('admin/supplier/supplier_header', $data);
        $this->load->view('admin/layout/footer', $data);
        $this->load->view('admin/supplier/edit_supplier_recordsone', $data); 
    ...
    public function update_supplier_contactss($id="")
    {
        ...
        redirect(base_url('admin/supplier/edit_supplier_contacts/'.$sessionid));
        }
        ...
        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/supplier/supplier_header', $data);
        $this->load->view('admin/supplier/edit_supplier_contact', $data);
        $this->load->view('admin/layout/footer', $data);
    }
     ...
     public function update_supplier_contacts($id="")
    {
        ...
        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/supplier/supplier_header', $data);
        $this->load->view('admin/supplier/edit_supplier_contactss', $data);
        $this->load->view('admin/layout/footer', $data);
    }
    ...
    public function edit_supplier_contacts($id="")
    {
        ...
        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/supplier/supplier_header', $data);
        $this->load->view('admin/supplier/edit_supplier_contacts', $data); 
        $this->load->view('admin/layout/footer', $data);
    }
    ...
    /*Start supplier Contact*/
     ...
     public function supplier_contact(){
        ...
        $this->load->view('admin/supplier/supplier_contact', $result);
    ...
    public function add_edit_supplier_contact()
    {   
    ...
    public function update_supplier_contactone($id="")
    {
        ...
        $this->load->view('admin/layout/header', $data);
        $this->load->view('admin/supplier/supplier_header', $data);
        $this->load->view('admin/supplier/edit_supplier_contactone', $data);
        $this->load->view('admin/layout/footer', $data);
    }
    ...
    $data = array(
        ...
        redirect(base_url('admin/supplier/prospects'));
    }
