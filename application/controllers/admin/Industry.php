...
public function __construct(){
    ...
    public function index(){
       $data = array();
        ...
        $data['main_content'] = $this->load->view('admin/industry/add', $data, TRUE);
        $this->load->view('admin/industry/add', $data);
 ...
 public function add()
    {   
        if ($_POST) {
            ...
            redirect(base_url('admin/industry/all_industry_list')); 
        }
    }
...
<?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'admin/industry/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
    ...
    {   
        ...
        $this->load->view('admin/industry/industry', $result);
