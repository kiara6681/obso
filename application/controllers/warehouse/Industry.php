...
public function __construct(){
    ...
    public function index(){
       $data = array();
        ...
        $data['main_content'] = $this->load->view('warehouse/industry/add', $data, TRUE);
        $this->load->view('warehouse/industry/add', $data);
 ...
 public function add()
    {   
        if ($_POST) {
            ...
            redirect(base_url('warehouse/industry/all_industry_list')); 
        }
    }
    ...
    public function update($id="")
    {
        ...
        // $this->load->view('warehouse/layout/header', $data);
        // $this->load->view('warehouse/layout/footer', $data);
        // $this->load->view('warehouse/industry/edit', $data);        
...
<?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'warehouse/industry/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                ...
                <button type="button" class="form-control" href="<?php echo base_url();?>warehouse/industry/all_industry_list">Cancel</button>
    ...
    {   
        ...
        $this->load->view('warehouse/industry/industry', $result);
