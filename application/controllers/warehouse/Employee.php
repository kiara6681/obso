...
class Employee extends CI_Controller {
   ...
   public function index(){
      ...
      $data['main_content'] = $this->load->view('warehouse/employee/add', $data, TRUE);
      $this->load->view('warehouse/employee/add', $data);
      ...
      if ($_POST) {
         ...
         if(!empty($return)){
            ...
            if($this->email->send()){
               ...
               redirect(base_url('warehouse/employee/all_employee_list'));       
            }else{
   ...
   public function update($id="")
   {
      ...
      <?php echo form_open(base_url() . 'warehouse/employee/update' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
   ...
   {   
      ...
      $this->load->view('warehouse/layout/header');
      $this->load->view('warehouse/layout/footer');
      $this->load->view('warehouse/employee/employee', $result);
   }
