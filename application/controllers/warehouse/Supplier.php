...
class supplier extends CI_Controller {
    ...
    public function delete_supplier_list($id)
    {
        ...
        redirect(base_url('warehouse/supplier/supplier_list'));
    }
    ...
    public function prospects(){
        ...
        $this->load->view('warehouse/supplier/prospects', $data);
    ...
    public function partner(){
        ...
        $this->load->view('warehouse/layout/header', $data);
        $this->load->view('warehouse/supplier/partner', $data);
        $this->load->view('warehouse/layout/footer', $data);
    ...
    public function supplier_records(){
        ...
        $this->load->view('warehouse/layout/header', $data);
        $this->load->view('warehouse/supplier/supplier_header', $data);
        $this->load->view('warehouse/supplier/supplier_records', $data);
        $this->load->view('warehouse/layout/footer', $data);
    }
    ...
    {       
        ...
        if ($_POST) {
            ...
            $this->load->view('warehouse/supplier/supplier_records', $this->session->all_userdata());
            $this->load->view('warehouse/supplier/edit_supplier_records', $data);
           redirect(base_url('warehouse/supplier/supplier_contact')); 
        }
    }
     ...
     public function supplier_list(){
        ...
        $this->load->view('warehouse/layout/header', $data);
        $this->load->view('warehouse/supplier/supplier_list', $data);
        $this->load->view('warehouse/layout/footer', $data);
    }
    ...
    public function update_supplier_contactss($id="")
    {
        ...
        redirect(base_url('warehouse/supplier/edit_supplier_contacts/'.$sessionid));
        }
        ...
        $this->load->view('warehouse/layout/header', $data);
        $this->load->view('warehouse/supplier/supplier_header', $data);
        $this->load->view('warehouse/supplier/edit_supplier_contact', $data);
        $this->load->view('warehouse/layout/footer', $data);
    }
     ...
     public function update_supplier_contacts($id="")
    {
        ...
        $this->load->view('warehouse/layout/header', $data);
        $this->load->view('warehouse/supplier/supplier_header', $data);
        $this->load->view('warehouse/supplier/edit_supplier_contactss', $data);
        $this->load->view('warehouse/layout/footer', $data);
    }
    ...
    public function edit_supplier_contacts($id="")
    {
        ...
        $this->load->view('warehouse/layout/header', $data);
        $this->load->view('warehouse/supplier/supplier_header', $data);
        $this->load->view('warehouse/supplier/edit_supplier_contacts', $data); 
        $this->load->view('warehouse/layout/footer', $data);
    }
    ...
    /*Start supplier Contact*/
     ...
     public function supplier_contact(){
        ...
        $this->load->view('warehouse/supplier/supplier_contact', $result);
    ...
    public function update_supplier_contactone($id="")
    {
        ...
        $this->load->view('warehouse/layout/header', $data);
        $this->load->view('warehouse/supplier/supplier_header', $data);
        $this->load->view('warehouse/supplier/edit_supplier_contactone', $data);
        $this->load->view('warehouse/layout/footer', $data);
    }
    ...
    $data = array(
        ...
        redirect(base_url('warehouse/supplier/prospects'));
    }
