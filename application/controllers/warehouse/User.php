...
class User extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['main_content'] = $this->load->view('warehouse/user/add', $data, TRUE);
    ...
    {   
        if ($_POST) {
            ...
            if (empty($email)) {
                ...
                redirect(base_url('warehouse/user/all_user_list'));
            } else {
                $this->session->set_flashdata('error_msg', 'Email already exist, try another email');
                redirect(base_url('warehouse/user'));
            }
    ...
    public function all_user_list()
    {
        ...
        $data['main_content'] = $this->load->view('warehouse/user/users', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
    ...
    public function update($id)
    {
        ...
        $data['country'] = $this->common_model->select('country');
        $data['main_content'] = $this->load->view('warehouse/user/edit_user', $data, TRUE);
    ...
    {   
        ...
        $data['main_content'] = $this->load->view('warehouse/user/user_power', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
    ...
    {   
        if (isset($_POST)) {
            ...
            redirect(base_url('warehouse/user/power'));
        }
