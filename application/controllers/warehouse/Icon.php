...
class Icon extends CI_Controller {
    ...
    public function font_awesome(){
        ...
        $data['main_content'] = $this->load->view('warehouse/icon/font_awesome', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
    ...
    public function themifyIcon(){
        ...
        $data['main_content'] = $this->load->view('warehouse/icon/themifyIcon', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
    ...
    public function simpleLineIcon(){
        ...
        $data['main_content'] = $this->load->view('warehouse/icon/simpleLineIcon', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
	 ...
	 public function lineIcon(){
        ...
        $data['main_content'] = $this->load->view('warehouse/icon/lineIcon', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
    ...
    public function weatherIcon(){
        ...
        $data['main_content'] = $this->load->view('warehouse/icon/weatherIcon', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
