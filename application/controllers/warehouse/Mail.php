...
class Mail extends CI_Controller {
    ...
    public function inbox(){
        ...
        $data['main_content'] = $this->load->view('warehouse/mail/inbox', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
    ...
    public function inbox_details(){
        ...
        $data['main_content'] = $this->load->view('warehouse/mail/inbox_details', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
    ...
    public function compose_message(){
        ...
        $data['main_content'] = $this->load->view('warehouse/mail/compose_message', $data, TRUE);
        $this->load->view('warehouse/index', $data);
    }
