        ...
        <div class="col-lg-12">
           ...
           <div class="panel panel-info">
                <div class="panel-heading"> 
                     <i class="fa fa-pencil"></i> &nbsp;User Edit <a href="<?php echo base_url('sales/user/all_user_list') ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i> All Users </a>
            ...
            <?php endif ?>
                    ...
                    <form method="post" action="<?php echo base_url('sales/user/update/'.$user->id) ?>" class="form-horizontal" novalidate>
