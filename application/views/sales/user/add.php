        ...
        <div class="col-lg-12">
           ...
           <div class="panel panel-info">
                <div class="panel-heading"> 
                     <i class="fa fa-plus"></i> &nbsp;Add New User <a href="<?php echo base_url('sales/user/all_user_list') ?>" class="btn btn-info btn-sm pull-right"><i class="fa fa-list"></i> List Users </a>
            ...
            <?php endif ?>
                    ...
                    <form method="post" action="<?php echo base_url('sales/user/add') ?>" class="form-horizontal" novalidate>
