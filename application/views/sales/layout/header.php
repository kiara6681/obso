                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>sales/dashboard" class="waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo base_url(); ?>sales/sales/customer_list"> Customer Lists</a></li>
                                <!--  <li><a href="<?//php echo base_url(); ?>sales/sales/customer_records">Customer Records</a></li> -->
                                <!--  <li><a href="<?//php echo base_url(); ?>sales/sales/customer_contact">Customer Contacts</a></li> -->
                                </ul>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo base_url();?>sales/supplier/supplier_list"> Supplier List</a></li>
                                <!--  <li><a href="<?php echo base_url();?>sales/supplier/supplier_records">Supplier Records</a></li> -->
                                <!--  <li><a href="<?php echo base_url();?>sales/supplier/supplier_contact">Supplier Contact</a></li> -->
                                </ul>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo base_url();?>sales/product/all_product_list">Product List</a></li>
                                    <li><a href="<?php echo base_url();?>sales/manufacturer/all_manufacturer_list">Manufacturer List</a></li>
                                    <li><a href="<?php echo base_url();?>sales/industry/all_industry_list">Industry List</a></li>
                                    <li><a href="<?php echo base_url();?>sales/employee/all_employee_list">Employee List</a></li>
