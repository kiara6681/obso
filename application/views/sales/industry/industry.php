                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" data-toggle="modal" data-target=".bs-example-modal-lgedit" onclick="get_product_edit(<?php echo $manufacturer['id']; ?>)"><i class="fas fa-edit"></i></a> | 
                                                    <a href="<?php echo base_url('sales/industry/delete/'.$manufacturer['id']) ?>" onClick="return doconfirm();" data-toggle="tooltip" data-original-title="Delete" class="far fa-trash-alt"></a></td>
        ...
        <div class="modal-body">
                ...
                <div class="modal-body">
                 ...
                 <?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'sales/industry/add' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <script type="text/javascript">
            ...
            $.ajax({
            url: '<?php echo base_url();?>sales/industry/update/' + id ,
