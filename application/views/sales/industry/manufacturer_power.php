        ...
        <div class="col-lg-5">
             <div class="panel panel-info">
              ...
              <div class="panel-body table-responsive">
                    <form method="post" action="<?php echo base_url('sales/manufacturer/add_power') ?>" class="form-horizontal" novalidate>
                        <div class="form-body">
                            <br>
                            <div class="row">
                                <div class="col-md-9">
                            ...
                            <?php foreach ($powers as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <a id="delete" href="<?php echo base_url('sales/manufacturer/delete_power/'.$row['id']) ?>"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash text-danger m-r-10"></i> </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="<?php echo base_url('sales/manufacturer/update_power') ?>" class="form-horizontal" novalidate>
            <div class="form-body">
                <br>
