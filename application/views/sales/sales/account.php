        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-justified" role="tablist">
            <li class="nav-item waves-effect waves-light">
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/sales/customer_list"){ ?>
              <a class="nav-link suspect" data-toggle="tab" href="<?php echo base_url(); ?>sales/sales/customer_list" role="tab">
                 <?php }else{ ?>
            <a class="nav-link" href="<?php echo base_url(); ?>sales/sales/customer_list">
            <?php } ?>
            ...
            <li class="nav-item waves-effect waves-light">
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/sales/prospects"){ ?>
              <a class="nav-link prospect" data-toggle="tab" href="<?php echo base_url(); ?>sales/sales/prospects" role="tab">
                 <?php }else{ ?>
              <a class="nav-link" href="<?php echo base_url(); ?>sales/sales/prospects">
            <?php } ?>
            ...
            <li class="nav-item waves-effect waves-light">
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/sales/account"){ ?>
              <a class="nav-link account" data-toggle="tab" href="<?php echo base_url(); ?>sales/sales/account" role="tab">
                 <?php }else{ ?>
              <a class="nav-link" href="<?php echo base_url(); ?>sales/sales/account">
            <?php } ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                       <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url('sales/sales/edit_customer_records/'.$customer_records['session_id']) ?>">Edit</a></li>
                        <!-- <li role="presentation"><a href="<?//php echo base_url('sales/sales/suspectstatus/'.$customer_records['id']) ?>">Susspect</a></li>
                        <li role="presentation"><a href="<?//php echo base_url('sales/sales/partnerstatus/'.$customer_records['id']) ?>">Account</a></li> -->
                        <li role="presentation"><a href="<?php echo base_url('sales/sales/markstatustwo/'.$customer_records['id']) ?>"><?php if($customer_records['mark_status'] ==0){ ?>Mark Active <?php }else{ ?> Mark Inactive<?php } ?></a></li>
                        <li role="presentation"><a href="<?php echo base_url('sales/sales/delete_customer_list/'.$customer_records['id']) ?>" onClick="return doconfirm();" role="menuitem" tabindex="-1">Delete</a></li>
                      </ul>
                    </div>
                ...
                <div class="card-body">
                  <div class="col-xl-12 col-md-4 col-sm-6 sup-bg">
                    <div class="button-items">
                      ...
                      <br>
                      <a href="<?php echo base_url(); ?>sales/sales/customer_records" class="btn btn-primary btn-lg btn-block waves-effect waves-light btn-radius"><i class="mdi mdi-cellphone-text"></i>Add New Company Records</a>
