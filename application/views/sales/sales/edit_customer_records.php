<div class="content-page">
  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <!-- end row -->
      <form action="<?php echo base_url('sales/sales/edit_customer_records'); ?>" method="POST" enctype="multipart/multipart/form-data">
      <div class="row">
      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link active" href="<?php echo base_url(); ?>sales/sales/customer_records/<?php  echo $customer_record->session_id; ?>">
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link" href="<?php echo base_url(); ?>sales/sales/edit_customer_contacts/<?php  echo $customer_record->session_id; ?>">
