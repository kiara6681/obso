      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <a class="nav-link " href="<?php echo base_url(); ?>sales/sales/edit_customer_records/<?php  echo $customer_record->session_id; ?>">
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link active" href="<?php echo base_url(); ?>sales/sales/edit_customer_contacts/<?php  echo $customer_record->session_id; ?>">
      ...
      <?php } ?>
        <div class="row" class="cpycls">
          ...
          <div class="col-md-1">
            ...
            <span class="editt"><a href="<?php echo base_url('sales/sales/update_customer_contacts/'.$customer_contact['id']) ?>" data-toggle="tooltip"><i class="mdi mdi-square-edit-outline"></i></a></span>
          </div>
          <br>
        </div>
      </div>
