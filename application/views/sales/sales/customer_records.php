<div class="content-page">
  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <!-- end row -->
      <form action="<?php echo base_url('sales/sales/add_customer_records'); ?>" method="POST" enctype="multipart/multipart/form-data">
      <div class="row">
              ...
              <div class="row">
                <div class="col-xl-3 col-md-3 col-sm-3 border-rgt">
                  ...
                  <div class="col-xl-12 col-md-12 col-sm-12" style="margin: 16px;"> 
                    <div class="row">
                      <div class="col-xl-12">
<p><input type="text" name="company_name" class="form-control addnewcompny" placeholder="Add New Company"  value="<?php if(isset($_SESSION['company_name'])){ echo $_SESSION['company_name']; }?>" required></p>
                      </div>
                    </div>
                  </div>  
                </div>
      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <a class="nav-link active" href="<?php echo base_url(); ?>sales/sales/customer_records">
            <?php }else{ ?>
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <a class="nav-link active" href="<?php echo base_url(); ?>sales/sales/customer_contact">
            <?php } } else{ 
                if(!empty($_SESSION['session_id'])){

              ?>
              <a class="nav-link" href="<?php echo base_url(); ?>sales/sales/customer_contact">
            <?php }  }?>
      ...
      <div class="col-lg-5">
        ...
        <hr><br>
          ...
          <div class="form-group">
            <textarea class="form-control" name="about"  placeholder="write some information on customer" style="height: 100px;" ><?php if(isset($_SESSION['about'])){ echo $_SESSION['about']; }?></textarea>
          </div>
          <div class="form-group">
            <div class="row">
              <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-sm-6">
                <input class="form-control" name="url" type="url" placeholder="https://example.com" value="<?php if(isset($_SESSION['url'])){ echo $_SESSION['url']; }?>" >
              </div>
              
              <div class="col-md-6">
                <select name="company_record" class="form-control" >
                  <option value="">Company Record Source</option>
                  <option value="email" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "email"){ ?> selected="selected" <?php }?>>E-mail</option>
                  <option value="self_generated" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "self_generated"){ ?> selected="selected" <?php }?>>Self Generated / Outbound Call</option>
                  <option value="google_search" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "google_search"){ ?> selected="selected" <?php }?>>Google Search</option>
                  <option value="bing_search" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "bing_search"){ ?> selected="selected" <?php }?>>Bing Search</option>
                  <option value="other_search_engine" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "other_search_engine"){ ?> selected="selected" <?php }?>>Other Search Engine</option>
                  <option value="google_ads" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "google_ads"){ ?> selected="selected" <?php }?>>Google Ads</option>
                  <option value="bing_ads" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "bing_ads"){ ?> selected="selected" <?php }?>>Bing Ads</option>
                  <option value="incoming_call" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "incoming_call"){ ?> selected="selected" <?php }?>>Incoming Call</option>
                  <option value="chat_facility" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "chat_facility"){ ?> selected="selected" <?php }?>>Chat Facility</option>
                  <option value="lead_forensics" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "lead_forensics"){ ?> selected="selected" <?php }?>>Lead Forensics</option>
                  <option value="e_linkdin" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "e_linkdin"){ ?> selected="selected" <?php }?>>E-LinkedIn</option>
                  <option value="facebook_lead" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "facebook_lead"){ ?> selected="selected" <?php }?>>Facebook Lead</option>
                  <option value="twitter_lead" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "twitter_lead"){ ?> selected="selected" <?php }?>>Twitter Lead</option>
                  <option value="instagram_lead" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "instagram_lead"){ ?> selected="selected" <?php }?>>Instagram Lead</option>
                  <option value="obso_ecommerce_refer" <?php if(isset($_SESSION['company_record']) && $_SESSION['company_record'] == "obso_ecommerce_refer"){ ?> selected="selected" <?php }?>>Obso ecommerce Refer</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-md-12">
                <input type="text" name="main_switchboard_number" class="form-control" value="<?php if(isset($_SESSION['main_switchboard_number'])){ echo $_SESSION['main_switchboard_number']; }?>" placeholder="Main Switchboard Number" />
              </div>
            </div>
          </div>
              ...
              <div class="card marbtmm" style="background: #222831 !important;">
                <div class="card-body">
                   ...
                   <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    ...
                    <?php if(isset($_SESSION['estimated_frequency']) && $_SESSION['estimated_frequency'] == "lessthenoneyear"){ ?>
                    ...
                    <?php if(isset($_SESSION['estimated_frequency']) && $_SESSION['estimated_frequency'] == "daily"){ ?>
                      <label class="btn btn-primary active">
                    ...
                    <?php if(isset($_SESSION['estimated_frequency']) && $_SESSION['estimated_frequency'] == "weekly"){ ?>
                      <label class="btn btn-primary active">
                    ...
                    <?php if(isset($_SESSION['estimated_frequency']) && $_SESSION['estimated_frequency'] == "monthly"){ ?>
                      <label class="btn btn-primary active">
                    ...
                    <?php if(isset($_SESSION['estimated_frequency']) && $_SESSION['estimated_frequency'] == "yearly"){ ?>
                       <label class="btn btn-primary active">
              ...
              <div class="col-xl-12 col-sm-6 col-md-12">
                <div class="card marbtmm" style="background: #222831 !important;">
                  <div class="card-body">
                     ...
                     <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <?php if(isset($_SESSION['estimated_spend']) && $_SESSION['estimated_spend'] == "lessthen50k"){ ?>
                      <label class="btn btn-primary active">
                    ...
                    <?php if(isset($_SESSION['estimated_spend']) && $_SESSION['estimated_spend'] == "50k"){ ?>
                      <label class="btn btn-primary active">
                    ...
                    <?php } ?>
                     ...
                     <?php if(isset($_SESSION['estimated_spend']) && $_SESSION['estimated_spend'] == "100kplus"){ ?>
                      <label class="btn btn-primary active">
                    ...
                    <?php if(isset($_SESSION['estimated_spend']) && $_SESSION['estimated_spend'] == "500kplus"){ ?>
                      <label class="btn btn-primary active">
                    ...
                    <?php if(isset($_SESSION['estimated_spend']) && $_SESSION['estimated_spend'] == "1mplus"){ ?>
                       <label class="btn btn-primary active">
            ...
            <div class=" col-md-12">
              <div class="row">
                ...
                <select name="payment_terms" class="form-control" >
                  ...
                  <option value="5050_advance" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "5050_advance"){ ?> selected="selected" <?php }?>>50/50 Advance</option>

                  <option value="7525_advance" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "7525_advance"){ ?> selected="selected" <?php }?>>75/25 Advance</option>

                  <option value="pay_to_ship" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "pay_to_ship"){ ?> selected="selected" <?php }?>>Pay to ship</option>

                  <option value="pay_on_delivery" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "pay_on_delivery"){ ?> selected="selected" <?php }?>>Pay on Delivery</option>

                  <option value="7days_doi" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "7days_doi"){ ?> selected="selected" <?php }?>>7 Days DOI</option>

                  <option value="14days_doi" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "14days_doi"){ ?> selected="selected" <?php }?>>14 Days DOI</option>

                  <option value="30days_doi" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "30days_doi"){ ?> selected="selected" <?php }?>>30 Days DOI</option>

                  <option value="60days_doi" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "60days_doi"){ ?> selected="selected" <?php }?>>60 Days DOI</option>

                  <option value="90days_doi" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "90days_doi"){ ?> selected="selected" <?php }?>>90 Days DOI</option>

                  <option value="eom" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "eom"){ ?> selected="selected" <?php }?>>EOM</option>

                  <option value="30_eom" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "30_eom"){ ?> selected="selected" <?php }?>>30 EOM</option>

                  <option value="60_eom" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "60_eom"){ ?> selected="selected" <?php }?>>60 EOM</option>

                  <option value="90_eom" <?php if(isset($_SESSION['payment_terms']) && $_SESSION['payment_terms'] == "90_eom"){ ?> selected="selected" <?php }?>>90 EOM</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div class="form-group">
            <div class=" col-md-12">
              <div class="row">
                <div class="col-md-3 p-0">Free To Trade:</div>
                <div class="col-md-9 p-0">

              
                <select name="free_trade" class="form-control" >
                  <option value="trade1" <?php if(isset($_SESSION['free_trade']) && $_SESSION['free_trade'] == "trade1"){ ?> selected="selected" <?php }?>>Trade 1</option>
                  <option value="trade2" <?php if(isset($_SESSION['free_trade']) && $_SESSION['free_trade'] == "trade2"){ ?> selected="selected" <?php }?>>Trade 2</option>
                  <option value="trade3" <?php if(isset($_SESSION['free_trade']) && $_SESSION['free_trade'] == "trade3"){ ?> selected="selected" <?php }?>>Trade 3</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div class="form-group">
            <div class=" col-md-12">
              <div class="row">
                <div class="col-md-4 p-0">Payment Freferance:</div>
                <div class="col-md-8 p-0">
     

              
                <input type="text" name="payment_ref" class="form-control" value="<?php if(isset($_SESSION['payment_ref'])){ echo $_SESSION['payment_ref']; }?>"  placeholder="Payment Reference | " >
              </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text"  name="other_manufacturer_used" placeholder="Other Manufacturer Used" style="height: 100px;" ><?php if(isset($_SESSION['other_manufacturer_used'])){ echo $_SESSION['other_manufacturer_used']; }?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="psl_information" placeholder="PSL Information" style="height: 100px;" ><?php if(isset($_SESSION['psl_information'])){ echo $_SESSION['psl_information']; }?></textarea>
              </div>
            </div>   
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="competitor_info" placeholder="Competitor Information" style="height: 100px;" ><?php if(isset($_SESSION['competitor_info'])){ echo $_SESSION['competitor_info']; }?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="discount_pricing_info" placeholder="Discount & Pricing Information:" style="height: 100px;" ><?php if(isset($_SESSION['discount_pricing_info'])){ echo $_SESSION['discount_pricing_info']; }?></textarea>
              </div>
            </div>   
          </div>
      </div> 
        ...
        <hr><br>  
          ...
          <div class="form-group">
            ...
            <div class="col-md-12" style="padding: 0px;">
              <div style="width: 100%">
                <iframe width="100%" height="500" src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=1%20Grafton%20Street%2C%20Dublin%2C%20Ireland+(My%20Business%20Name)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.maps.ie/map-my-route/">Draw map route</a></iframe>
              </div><br />
            </div>
