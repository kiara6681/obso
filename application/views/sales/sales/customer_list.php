                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation"><a href="<?php echo base_url('sales/sales/prospectstatus/'.$customer_records['id']) ?>">Prospect</a></li>
                        <li role="presentation"><a href="<?php echo base_url('sales/sales/partnerstatus/'.$customer_records['id']) ?>">Account</a></li>
                        <li role="presentation"><a href="<?php echo base_url('sales/sales/markstatusone/'.$customer_records['id']) ?>"><?php if($customer_records['mark_status'] ==0){ ?>Mark Inactive <?php }else{ ?> Mark Active<?php } ?></a></li>
