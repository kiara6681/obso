        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-justified" role="tablist">
            <li class="nav-item waves-effect waves-light border-rgt">
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/employee/all_employee_list"){ ?>
              <a class="nav-link suspect" data-toggle="tab" href="<?php echo base_url(); ?>sales/employee/all_employee_list" role="tab">
                <?php }else{ ?>
                  <a class="nav-link" href="<?php echo base_url(); ?>sales/employee/all_employee_list">
            <?php } ?>
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
              ...
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/employee/prospects"){ ?>
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
               ...
               <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/employee/partner"){ ?>
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
               <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/employee/chat_history"){ ?>
              <a class="nav-link" data-toggle="tab" href="#" role="tab" style="background: rgb(57, 54, 223);">
                <?php }else{ ?>
                  <a class="nav-link" href="#">
            <?php } ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation"><a href="<?php echo base_url('sales/employee/delete/'.$employee_records['id']) ?>" onClick="return doconfirm();" role="menuitem" tabindex="-1">Delete</a></li>
                      </ul>
                    </div>
                    </div>
        ...
        <div class="modal-body">
                ...
                <div class="modal-body">
                 ...
                 <?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'sales/employee/add' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
...
<script type="text/javascript">
  ...
  function get_supplier_val(class_id) {
      ...
      $.ajax({
            url: '<?php echo base_url();?>sales/employee/ajax_get_supplier_details/' + class_id ,
 ...
 function get_employee_edit(id) {
      $.ajax({
            url: '<?php echo base_url();?>sales/employee/update/' + id ,
            success: function(response)
            {
