    ...
    <div id="wrapper"> 
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="icon-grid"></i></a>
                <div class="top-left-part"><a class="logo" href="<?php echo base_url('sales/dashboard/') ?>"><b><img src="<?php echo base_url();?>optimum/small.png" alt="Codeig" /></b><span class="hidden-xs">Igniter Admin</span></a></div>
 ...
 <ul class="nav navbar-top-links navbar-right pull-right">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="<?php echo base_url('sales/dashboard') ?>" class="waves-effect"><i class="ti-dashboard p-r-10"></i> <span class="hide-menu">Dashboard</span></a> </li>
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-user p-r-10"></i> <span class="hide-menu"> Create User <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">3</span></span></a>
						...
						<?php if ($this->session->userdata('role') == 'admin'): ?>
                             <li> <a href="<?php echo base_url('sales/user') ?>"><i class="fa fa-plus p-r-10"></i><span class="hide-menu">New User</span></a></li>
							 <li> <a href="<?php echo base_url('sales/user/power') ?>"><i class="fa fa-cog p-r-10"></i><span class="hide-menu">User Function</span></a></li>
							  <?php else: ?>
							   <?php if(check_power(1)):?>
                            <li> <a href="<?php echo base_url('sales/user') ?>"><i class="fa fa-plus p-r-10"></i><span class="hide-menu">New User</span></a></li>
                            <?php endif; ?>
                            <?php endif ?>
						<li><a href="<?php echo base_url('sales/user/all_user_list') ?>"><i class="fa fa-list p-r-10"></i><span class="hide-menu">All Users</span></a></li>
                      </ul>
                    </li>
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-envelope p-r-10"></i> <span class="hide-menu"> Mailbox <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">6</span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo base_url('sales/mail/inbox') ?>">Inbox</a></li>
                            <li> <a href="<?php echo base_url('sales/mail/inbox_details') ?>">Inbox detail</a></li>
                            <li> <a href="<?php echo base_url('sales/mail/compose_message') ?>">Compose mail</a></li>
                        </ul>
                    </li>
					...
					<li> <a href="#" class="waves-effect"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">UI Elements<span class="fa arrow"></span> <span class="label label-rouded label-info pull-right">25</span> </span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url('sales/ui/card') ?>">Cards</a></li>
                            <li><a href="<?php echo base_url('sales/ui/panel_well') ?>">Panels and Wells</a></li>
                            <li><a href="<?php echo base_url('sales/ui/panel_block') ?>">Panels With BlockUI</a></li>
                            <li><a href="<?php echo base_url('sales/ui/drag_panel') ?>">Draggable Panel</a></li>
                            <li><a href="<?php echo base_url('sales/ui/dragPortlet') ?>">Draggable Portlet</a></li>
                            <li><a href="<?php echo base_url('sales/ui/buttons') ?>">Buttons</a></li>
                            <li><a href="<?php echo base_url('sales/ui/bootsrap_switch') ?>">Bootstrap Switch</a></li>
                            <li><a href="<?php echo base_url('sales/ui/date_pagination') ?>">Date Paginator</a></li>
                            <li><a href="<?php echo base_url('sales/ui/sweet_alert') ?>">Sweat alert</a></li>
                            <li><a href="<?php echo base_url('sales/ui/typography') ?>">Typography</a></li>
                            <li><a href="<?php echo base_url('sales/ui/grid') ?>">Grid</a></li>
                            <li><a href="<?php echo base_url('sales/ui/tabs') ?>">Tabs</a></li>
                            <li><a href="<?php echo base_url('sales/ui/stylish') ?>">Stylish Tabs</a></li>
                            <li><a href="<?php echo base_url('sales/ui/modals') ?>">Modals</a></li>
                            <li><a href="<?php echo base_url('sales/ui/progressbar') ?>">Progress Bars</a></li>
                            <li><a href="<?php echo base_url('sales/ui/notification') ?>">Notifications</a></li>
                            <li><a href="<?php echo base_url('sales/ui/carousel') ?>">Carousel</a></li>
                            <li><a href="<?php echo base_url('sales/ui/list_media') ?>">List & Media object</a></li>
                            <li><a href="<?php echo base_url('sales/ui/user_card') ?>">User Cards</a></li>
                            <li><a href="<?php echo base_url('sales/ui/timeline') ?>">Timeline</a></li>
                            <li><a href="<?php echo base_url('sales/ui/horizontal_timeline') ?>">Horizontal Timeline</a></li>
                            <li><a href="<?php echo base_url('sales/ui/nestable') ?>">Nesteble</a></li>
                            <li><a href="<?php echo base_url('sales/ui/range_slider') ?>">Range Slider</a></li>
                            <li><a href="<?php echo base_url('sales/ui/ribbon') ?>">Ribbons</a></li>
                            <li><a href="<?php echo base_url('sales/ui/steps') ?>">Steps</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-chart p-r-10"></i> <span class="hide-menu"> Reports <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo base_url('sales/report/payment_report') ?>">Payment Report</a></li>
                            <li> <a href="<?php echo base_url('sales/report/income_report') ?>">Income Report</a></li>
                            <li> <a href="<?php echo base_url('sales/report/sales_report') ?>">Sales Report</a></li>
                        </ul>
                    </li>
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-inr p-r-10"></i> <span class="hide-menu"> Payments <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo base_url('sales/payment/all_payments') ?>">All Payments</a></li>
                            <li> <a href="<?php echo base_url('sales/payment/create_payment') ?>">Create Payment</a></li>
                            <li> <a href="<?php echo base_url('sales/payment/payment_invoice') ?>">Payment Invoice</a></li>
                        </ul>
                    </li>
					 ...
					 <li> <a href="forms.html" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Forms<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url('sales/form/form_basic') ?>">Basic Forms</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_layout') ?>">Form Layout</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_addon') ?>">Form Addons</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_material') ?>">Form Material</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_float') ?>">Form Float Input</a></li>
                            <li><a href="<?php echo base_url('sales/form/file_upload') ?>">File Upload</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_mask') ?>">Form Mask</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_validation') ?>">Form Validation</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_dropzone') ?>">File Dropzone</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_picker') ?>">Form-pickers</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_icheck') ?>">Icheck Form Controls</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_wizard') ?>">Form-wizards</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_typehead') ?>">Typehead</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_editable') ?>">X-editable</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_summernote') ?>">Summernote</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_wysihtml5') ?>">Bootstrap wysihtml5</a></li>
                            <li><a href="<?php echo base_url('sales/form/form_tinymyce') ?>">Tinymce wysihtml5</a></li>
                        </ul>
                    </li>
					<li> <a href="<?php echo base_url('sales/dashboard/backup') ?>" class="waves-effect"><i data-icon="P" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Backup Database</span></a> </li>
					
                    <li> <a href="<?php echo base_url('sales/widget/widget') ?>" class="waves-effect"><i data-icon="P" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Widgets</span></a> </li>
                    <li> <a href="#" class="waves-effect"><i data-icon="7" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Icons<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?php echo base_url('sales/icon/font_awesome') ?>">Font awesome</a> </li>
                            <li> <a href="<?php echo base_url('sales/icon/themifyIcon') ?>">Themify Icons</a> </li>
                            <li> <a href="<?php echo base_url('sales/icon/simpleLineIcon') ?>">Simple line Icons</a> </li>
                            <li><a href="<?php echo base_url('sales/icon/lineIcon') ?>">Linea Icons</a></li>
                            <li><a href="<?php echo base_url('sales/icon/weatherIcon') ?>">Weather Icons</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="#" class="waves-effect"><i data-icon="&#xe008;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Sample Pages<span class="fa arrow"></span><span class="label label-rouded label-purple pull-right">29</span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url('sales/page/starter') ?>">Starter Page</a></li>
                            <li><a href="<?php echo base_url('sales/page/blank') ?>">Blank Page</a></li>
                            <li><a href="javascript:void(0)" class="waves-effect">Email Templates
            <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a href="<?php echo base_url('sales/page/email_basic') ?>">Basic</a></li>
                                    <li><a href="<?php echo base_url('sales/page/email_alert') ?>">Alert</a></li>
                                    <li><a href="<?php echo base_url('sales/page/email_billing') ?>">Billing</a></li>
                                    <li><a href="<?php echo base_url('sales/page/reset_password') ?>">Reset Password</a></li>
                                </ul>
                            </li>
                            <li><a href="<?php echo base_url('sales/page/lightBox') ?>">Lightbox Popup</a></li>
                            <li><a href="<?php echo base_url('sales/page/treeview') ?>">Treeview</a></li>
                            <li><a href="<?php echo base_url('sales/page/search_result') ?>">Search Result</a></li>
                            <li><a href="<?php echo base_url('sales/page/utility_class') ?>">Utility Classes</a></li>
                            <li><a href="<?php echo base_url('sales/page/custom_scroll') ?>">Custom Scrolls</a></li>
                            <li><a href="<?php echo base_url('sales/page/login_page') ?>">Login Page</a></li>
                            <li><a href="<?php echo base_url('sales/page/second_login') ?>">Login v2</a></li>
                            <li><a href="<?php echo base_url('sales/page/animation') ?>">Animations</a></li>
                            <li><a href="<?php echo base_url('sales/page/profile') ?>">Profile</a></li>
                            <li><a href="<?php echo base_url('sales/page/invoice') ?>">Invoice</a></li>
                            <li><a href="<?php echo base_url('sales/page/faq') ?>">FAQ</a></li>
                            <li><a href="<?php echo base_url('sales/page/gallery') ?>">Gallery</a></li>
                            <li><a href="<?php echo base_url('sales/page/pricing') ?>">Pricing</a></li>
                            <li><a href="<?php echo base_url('sales/page/register') ?>">Register</a></li>
                            <li><a href="<?php echo base_url('sales/page/second_register') ?>">Register v2</a></li>
                            <li><a href="<?php echo base_url('sales/page/step_registration') ?>">3 Step Registration</a></li>
                            <li><a href="<?php echo base_url('sales/page/recover_password') ?>">Recover Password</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="tables.html" class="waves-effect"><i data-icon="O" class="linea-icon linea-software fa-fw"></i> <span class="hide-menu">Tables<span class="fa arrow"></span><span class="label label-rouded label-info pull-right">7</span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url('sales/table/basic_table') ?>">Basic Tables</a></li>
                            <li><a href="<?php echo base_url('sales/table/table_layout') ?>">Table Layouts</a></li>
                            <li><a href="<?php echo base_url('sales/table/data_table') ?>">Data Table</a></li>
                            <li><a href="<?php echo base_url('sales/table/bootsrap_table') ?>">Bootstrap Tables</a></li>
                            <li><a href="<?php echo base_url('sales/table/responsive_table') ?>">Responsive Tables</a></li>
                            <li><a href="<?php echo base_url('sales/table/editable_table') ?>">Editable Tables</a></li>
                            <li><a href="<?php echo base_url('sales/table/footable') ?>">FooTables</a></li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper">
			...
			<div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <a href="" target="_blank" class="btn pull-right m-l-20 btn-info btn-rounded btn-sm">Buy Now</a>
                        <ol class="breadcrumb">
                            <li><a href="<?php echo base_url();?>sales/dashboard/">Home</a></li>
