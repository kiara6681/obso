...
<!-- end row -->
<form action="<?php echo base_url('sales/supplier/add_supplier_records'); ?>" method="POST" enctype="multipart/multipart/form-data">
<div class="row">
...
<div class="row">
<div class="col-xl-12">
<h3><input type="text" name="company_name" class="form-control addnewcompny" placeholder="Add New Company" value="<?php if(isset($_SESSION['company_name'])){ echo $_SESSION['company_name']; }?>" required></h3>
</div>
</div>
</div>  
</div>
    ...
    <ul class="nav nav-pills nav-justified" role="tablist">
      <li class="nav-item waves-effect waves-light border-rgt">
        ...
        <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/supplier/supplier_records"){ ?>
            ...
            <?php }else{ ?>
            <a class="nav-link" href="<?php echo base_url(); ?>sales/supplier/supplier_records">
            <?php } ?>
                ...
                <div class="card" style="background: #222831 !important;">
                  <div class="card-body">
                     ...
                     <div class="btn-group btn-group-toggle" data-toggle="buttons">
                       ...
                       <?php if(isset($_SESSION['standard_delivery']) && $_SESSION['standard_delivery'] == "lessthen50k"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="standard_delivery" value="lessthen50k" > less then 50k
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="standard_delivery" value="lessthen50k" > less then 50k
          ...
          <div class="form-group">
              ...
              <div class="col-md-12" >
                <div class="row">
                  ...
                  <div class="col-md-6 p-0"><input type="text" name="discount_pricing" class="form-control"  placeholder="Discount & Pricing Information" value="<?php if(isset($_SESSION['discount_pricing'])){ echo $_SESSION['discount_pricing']; }?>" ></div>
            ...
            <div class="row">                   
             ...
             <div class="form-group">
              ...
              <div class="col-md-12" >
                <div class="row">
                  <div class="col-md-6 p-0">Other Manufacturers Supplied:</div>
                  <div class="col-md-6 p-0"><input type="text" name="other_manufacturer" class="form-control"  placeholder="Other Manufacturers Supplied" value="<?php if(isset($_SESSION['other_manufacturer'])){ echo $_SESSION['other_manufacturer']; }?>" ></div>
            ...
            <div class="row">
             ...
             <div class="btn-group btn-group-toggle" data-toggle="buttons">
              ...
              <?php if(isset($_SESSION['product_condition']) && $_SESSION['product_condition'] == "factorysealed"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="product_condition" value="factorysealed" > Factory Sealed
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if(isset($_SESSION['product_condition']) && $_SESSION['product_condition'] == "openbox"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="product_condition" value="openbox" > Open Box
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if(isset($_SESSION['product_condition']) && $_SESSION['product_condition'] == "used"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="product_condition" value="used" > used Box
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php } ?>
                     ...
                     <?php if(isset($_SESSION['product_condition']) && $_SESSION['product_condition'] == "exchange"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="product_condition" value="exchange" > Exchange
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if(isset($_SESSION['product_condition']) && $_SESSION['product_condition'] == "repair"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="product_condition" value="repair" > Repair
                      </label>
                    <?php }else{ ?>
