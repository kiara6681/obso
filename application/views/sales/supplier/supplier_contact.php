    ...
    <ul class="nav nav-pills nav-justified" role="tablist">
      ...
      <li class="nav-item waves-effect waves-light border-rgt">
          ...
          <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/supplier/supplier_contact"){ ?>
            <a class="nav-link active" href="<?php echo base_url(); ?>sales/supplier/supplier_contact">
            <?php }else{ ?>
              <a class="nav-link" href="<?php echo base_url(); ?>sales/supplier/supplier_contact">
            <?php } ?>
        ...
        <div class="row" class="cpycls">
          ...
          <div class="col-md-1">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
              ...
              <li role="presentation"><a href="<?php echo base_url('sales/supplier/markstatus/'.$supplier_contact['id']) ?>"><?php if($supplier_contact['mark_status'] ==0){ ?>Mark In Active <?php }else{ ?> Mark Active<?php } ?></a></li>
            ...
            <span class="editt"><a href="<?php echo base_url('sales/supplier/update_supplier_contact/'.$supplier_contact['id']) ?>" data-toggle="tooltip"><i class="mdi mdi-square-edit-outline"></i></a></span>
          </div>
          <br>
        </div>
      </div>
