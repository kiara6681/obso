        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-justified" role="tablist">
            <li class="nav-item waves-effect waves-light border-rgt">
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/supplier/supplier_list"){ ?>
              <a class="nav-link suspect" data-toggle="tab" href="<?php echo base_url(); ?>sales/supplier/supplier_list" role="tab">
                <?php }else{ ?>
                  <a class="nav-link" href="<?php echo base_url(); ?>sales/supplier/supplier_list">
            <?php } ?>
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
              ...
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/supplier/prospects"){ ?>
              <a class="nav-link" data-toggle="tab" href="<?php echo base_url(); ?>sales/supplier/prospects" role="tab">
                <?php }else{ ?>
                  <a class="nav-link" href="<?php echo base_url(); ?>sales/supplier/prospects">
            <?php } ?>
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
               ...
               <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/supplier/partner"){ ?>
              <a class="nav-link" data-toggle="tab" href="<?php echo base_url(); ?>sales/supplier/partner" role="tab" style="background: rgb(57, 54, 223);">
                <?php }else{ ?>
                  <a class="nav-link" href="<?php echo base_url(); ?>sales/supplier/partner">
            <?php } ?>
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
               <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/supplier/chat_history"){ ?>
              <a class="nav-link" data-toggle="tab" href="<?php echo base_url(); ?>sales/supplier/chat_history" role="tab" style="background: rgb(57, 54, 223);">
                <?php }else{ ?>
                  <a class="nav-link" href="<?php echo base_url(); ?>sales/supplier/chat_history">
            <?php } ?>
              ...
              <div class="row p-9">
                <div class="col-xl-6 col-md-4 col-sm-6 border-rgt p-top12">
                  ...
                  <div class="col-md-12 m-l-30">
                     <p> 
                      Company  : <strong style="font-size: 20px;"><a style="color: #000 !important;" href="<?php echo base_url('sales/supplier/edit_supplier_records/'.$supplier_records['session_id']) ?>"><?php echo $supplier_records['company_name']; ?></a></strong><br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url('sales/supplier/edit_supplier_records/'.$supplier_records['session_id']) ?>">Edit</a></li>
                        <!-- <li role="presentation"><a href="#">Copy</a></li> -->
                        <li role="presentation"><a href="<?php echo base_url('sales/supplier/prospectstatus/'.$supplier_records['id']) ?>">Supplier</a></li>
                        <li role="presentation"><a href="<?php echo base_url('sales/supplier/partnerstatus/'.$supplier_records['id']) ?>">Partner Supplier</a></li>
                        <li role="presentation"><a href="<?php echo base_url('sales/supplier/markstatusone/'.$supplier_records['id']) ?>"><?php if($supplier_records['mark_status'] ==0){ ?>Mark In Active <?php }else{ ?> Mark Active<?php } ?></a></li>
                        <li role="presentation"><a href="<?php echo base_url('sales/supplier/delete_supplier_list/'.$supplier_records['id']) ?>" onClick="return doconfirm();" role="menuitem" tabindex="-1">Delete</a></li>
                      </ul>
                    </div>

                     <div class="col-md-12 text-right">
                      <a href="<?php echo base_url('sales/supplier/edit_supplier_records/'.$supplier_records['session_id']) ?>">
            ...
            <h1>Marketed in last month 24% 61</h1>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-xl-12 col-md-4 col-sm-6 sup-bg p-0">
                    <div class="button-items ">
                      <a href="<?php echo base_url();?>sales/supplier/supplier_records" class="btn btn-primary btn-lg btn-block waves-effect waves-light"><i class="mdi mdi-cellphone-text"></i>Add New Supplier Record</a>
