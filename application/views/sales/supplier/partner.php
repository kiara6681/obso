        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-justified" role="tablist">
            ...
            <?php } ?>
                ...
                Potential Supplier(<?php  echo $suspest; ?>)</span> 
              </a>
            </li>
            <li class="nav-item waves-effect waves-light">
              <?php if( $_SERVER['REQUEST_URI'] == "/obsosales/sales/supplier/prospects"){ ?>
              <a class="nav-link prospect" data-toggle="tab" href="<?php echo base_url(); ?>sales/supplier/prospects" role="tab">
                 <?php }else{ ?>
            ...
            <li class="nav-item waves-effect waves-light">
              ...
              <a class="nav-link account" data-toggle="tab" href="<?php echo base_url(); ?>sales/supplier/partner" role="tab">
                 <?php }else{ ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <!-- <li role="presentation"><a href="<?//php echo base_url('sales/supplier/suspectstatus/'.$supplier_records['id']) ?>">Potential Supplier</a></li>
                        <li role="presentation"><a href="<?//php echo base_url('sales/supplier/partnersupplier/'.$supplier_records['id']) ?>">Partner Supplier</a></li> -->
