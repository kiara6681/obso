              ...
              <div class="row">
                <div class="col-xl-3 col-md-3 col-sm-3 border-rgt">
                  ...
                  <div class="col-xl-12 col-md-12 col-sm-12" style="margin: 16px;"> 
                    <div class="row">
                      <div class="col-xl-12">
                      <p><input type="text" name="company_name" class="form-control addnewcompny" placeholder="Add New Company" style="font-size: 20px;text-align: center;" required value="<?php echo $supplier_record->company_name; ?>"></p>
                      </div>
                    </div>
                  </div>  
                </div>
      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <a class="nav-link " href="<?php echo base_url(); ?>sales/supplier/edit_supplier_records/<?php  echo $supplier_record->session_id; ?>">
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link active" href="<?php echo base_url(); ?>sales/supplier/edit_supplier_contacts/<?php  echo $supplier_record->session_id; ?>">
...
<div class="row">
        ...
        <div class="row" class="cpycls">
          ...
          <div class="col-md-1">
            ...
            <!-- <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
              ...
              <li role="presentation"><a href="<?php echo base_url('sales/supplier/markstatus/'.$supplier_contact['id']) ?>"><?php if($supplier_contact['mark_status'] ==1){ ?>Mark Active <?php }else{ ?> Mark Inactive<?php } ?></a></li>
              <li role="presentation"><a href="<?php echo base_url('sales/supplier/delete/'.$supplier_contact['id']) ?>" onClick="return doconfirm();" data-toggle="tooltip" data-original-title="Delete">Delete</a></li>
            </ul> -->
            <span class="editt"><a href="<?php echo base_url('sales/supplier/update_supplier_contacts/'.$supplier_contact['id']) ?>" data-toggle="tooltip"><i class="mdi mdi-square-edit-outline"></i></a></span>
          </div>
          <br>
        </div>
      </div>
  ...
  <!-- <div class="col-xl-7 col-md-6 col-sm-6"> -->
    ...
    <div class="row">
      <div class="col-lg-12">
        <form action="<?php echo base_url('sales/supplier/add_supplier_contact'); ?>" method="POST" enctype="multipart/multipart/form-data">
