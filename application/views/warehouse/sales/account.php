                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                       <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url('admin/sales/edit_customer_records/'.$customer_records['session_id']) ?>">Edit</a></li>
                        <!-- <li role="presentation"><a href="<?//php echo base_url('admin/sales/suspectstatus/'.$customer_records['id']) ?>">Susspect</a></li>
                        <li role="presentation"><a href="<?//php echo base_url('admin/sales/partnerstatus/'.$customer_records['id']) ?>">Account</a></li> -->
                        <li role="presentation"><a href="<?php echo base_url('admin/sales/markstatustwo/'.$customer_records['id']) ?>"><?php if($customer_records['mark_status'] ==0){ ?>Mark Active <?php }else{ ?> Mark Inactive<?php } ?></a></li>
                        <li role="presentation"><a href="<?php echo base_url('admin/sales/delete_customer_list/'.$customer_records['id']) ?>" onClick="return doconfirm();" role="menuitem" tabindex="-1">Delete</a></li>
                      </ul>
                    </div>
