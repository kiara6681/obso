                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <?php endif ?>
                                        <form class="" action="<?php echo base_url('admin/manufacturer/update'); ?>" method="POST" enctype="multipart/multipart/form-data">
                            ...
                            <div>
                                                    ...
                                                    <a href="<?php echo base_url();?>admin/manufacturer/all_manufacturer_list" class="btn btn-secondary waves-effect">
                                                        Cancel
                                                    </a>
                                                </div>
                                            </div>
