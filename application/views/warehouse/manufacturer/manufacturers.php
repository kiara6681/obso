                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" data-toggle="modal" data-target=".bs-example-modal-lgedit" onclick="get_product_edit(<?php echo $manufacturer['id']; ?>)"><i class="fas fa-edit"></i></a> | 
                                                    <a href="<?php echo base_url('admin/manufacturer/delete/'.$manufacturer['id']) ?>" onClick="return doconfirm();" data-toggle="tooltip" data-original-title="Delete" class="far fa-trash-alt"></a></td>
                 ...
                 <?php $this->load->helper('form'); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <button type="button" class="form-control" href="<?php echo base_url();?>admin/manufacturer/all_manufacturer_list">Cancel</button>
