          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-xl-6 col-md-6 col-sm-6 text-center">
                <a href="<?php echo base_url();?>admin/supplier/supplier_records"><button type="button" name="cancel" class="btn btn-secondary btn-sm waves-effect waves-light savebtn clr">Cancel</button></a>
