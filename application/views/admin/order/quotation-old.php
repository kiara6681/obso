      ...
      <div class="row">
        ...
        <div class="cards">
          <div class="card-body">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <h7 class="heading"> Enquiry Ref. no.: #<?= str_pad($invoice_no, 7, '0', STR_PAD_LEFT); ?></h7>
                &nbsp;&nbsp;&nbsp;<h3>  |</h3>&nbsp;&nbsp;&nbsp;
          ...
          <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" /> 
                <input type="hidden" name="orderno" value="<?= $invoice_no ?>">
            <!-- row end-->
            <?php 
            $i = 1;
// 
                ...
                <div class="card-body">
                  <div class="row" style="margin: -8px;padding: 0px;">
                      ...
                      <div class="col-md-3" style="margin-top: 10px;">
                        ...
                        <p> 
                          Product Quantity:<input type="text" name="prod_quantity[]" class="form-control product-quantity" style="width: 50%;float: right;height: 29px;" value="" readonly>
                        ...
                        <div>
                        <p> 
                            Total Supplier:<input type="text" name="total_supplier[]" class="form-control total-supplier" style="width: 50%;float: right;height: 29px;" value="" readonly> 
                        </p>
                        </div>
                 ...
                 <?php   } ?>
                        ...
                        <div class="col-xl-2" style="border-right: 1px solid #273044;">
                          ...
                          <div class="col-xl-7 p-0">
                            ...
                            <button type="button" class="btn btn-secondary btn-sm waves-effect waves-light savebtn clr action-btn-cancel"style="width: 10%; margin-left: 10px">Cancel</button>
                            <button type="button" class="btn btn-secondary btn-sm waves-effect waves-light savebtn clr action-btn-save"style="width: 10%;margin-left: 10px">Save</button>
                            <button type="button" class="btn btn-secondary btn-sm waves-effect waves-light savebtn clr action-btn-add"style="width: 28%; display: none">Add new Suppliers</button>
                      ...
                      <div class="col-md-4">
                        <p>
                          ...
                          <div style="margin-top: -25px;">
                            <p> 
                              Note:<textarea type="text" name="note" class="form-control" style="width: 80%;float: right;height: 200px;background: #252735;" value="12345678"> </textarea>
                            </p>
                          </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <table class="table mb-0 teb">
                            <thead>
                              <tr>
                                <th style="background: none;border: #252735;"><h4>Total<input type="hidden" name="total-amount" value="0.00"></h4></th>
                                <th style="background: none;border: #252735;"><h4><i fas fa-pound-sign></i><span class="total-amount">0.00</span></h4></th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <th>+VAT (%)<input type=""  class="form-control vat cal-persentage" value="0" name="vat" style="width: 20%;">
                                <input type="hidden" name="vat-amount" value="0.00"> </th>
                                <td class="cal-vat">0.00</td>
                              </tr>
                              <tr>
                                <th>- Discount (%)<input type=""  class="form-control vat discount cal-persentage" value="0" name="discount" style="width: 20%;"> 
                                <input type="hidden" name="discount-amount" value="0.00">  
                                </th>
                                <td class="cal-discount">0.00</td>
                              </tr>
                              <tr>
                                <th style="border-top: 1px solid #5d5e66 !important"><h4>NET Total</h4></th>
                                <td style="border-top: 1px solid #5d5e66 !important"><h4><i fas fa-pound-sign></i><input type="hidden" name="netTotal" value="0.00"><span class="sum-total-amount">0.00</span></h4></td>
                              </tr>
                            </tbody>
                          </table>
                        </div> 
...
<script type="text/javascript">
  jQuery(document).ready(function($) {
    ...
    $('body').on('keyup', '.calculat_tatal', function(event) {
      ...
      $('body').find('.cal-vat').text(parseFloat(vattotal));
      $('body').find('input[name="vat-amount"]').val(parseFloat(vattotal));
      }
      var discountAmount=0;
      var discount=$('body').find('.discount').val();
      if(discount){
      discountAmount=parseFloat(totalsum)/100*parseFloat(discount);
      $('body').find('.cal-discount').text(parseFloat(discountAmount));
      $('body').find('input[name="discount-amount"]').val(parseFloat(discountAmount));
      }
    ...
    $('body').on('click', '.action-btn-save', function(event) {
      ...
      var wholebox=$this.closest('.whole-box');
      var totalrow=wholebox.find('tr');
      console.log(totalrow);
      total_supplier.val(totalrow.length-1);
      ...
      var itemMain=wholebox.find('.itemid');
