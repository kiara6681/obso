                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <?php endif ?>
                                        <form class="" action="<?php echo base_url('admin/subcategories/add'); ?>" method="POST" enctype="multipart/multipart/form-data">
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Cubcategories</label>
                                                <div class="col-sm-10">
                            ...
                            <div>
                                                    ...
                                                    <a href="<?php echo base_url();?>admin/subcategories/all_subcategories_list" class="btn btn-secondary waves-effect">
                                                        Cancel
                                                    </a>
                                                </div>
                                            </div>
