<div class="content-page">
  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <!-- end row -->
      <form action="<?php echo base_url('admin/sales/edit_customer_recordsone'); ?>" method="POST" enctype="multipart/multipart/form-data">
      <div class="row">
      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link active" href="<?php echo base_url(); ?>admin/sales/customer_recordsone/<?php  echo $customer_record->session_id; ?>">
