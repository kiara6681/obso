        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="mt-0 header-title">All Sales Contact</h4>
                        </div>
                    </div>
                                            ...
                                            <div class="row p-9">
                                                <div class="col-xl-6 col-md-4 col-sm-6 border-rgt p-top12">
                                                    ...
                                                    <div class="col-md-12 m-l-30">
                                                        <p> 
                                                            Name  : <?= $contact['fname'].' '.$contact['fname']; ?> 
                                                            <br>
                                                            Company : <?= $contact['industry_name']; ?> 
                                                            <!-- <br>
                                                            Record Source : <?= $contact['record_source']; ?> -->
                                                        </p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-2">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                                                <a role="menuitem" tabindex="-1" href="<?= base_url('admin/companies/edit_company/'.$contact['id']) ?>">
                                                                  <li role="presentation">Edit</li>
                                                                </a>
                                                                <a href="<?= base_url('admin/companies/archieve/'.$contact['id']) ?>" onclick="return confirm('Are you sure you want to remove the contact?')" role="menuitem" tabindex="-1">
