        ...
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <?php } ?>
              ...
              Record Information<?php if(isset($_SESSION['session_id'])) { echo $_SESSION['session_id']; } ?> </span> 
            </a>
          </li>
          <li class="nav-item waves-effect waves-light border-rgt">
    ...
    <div class="row">
      <div class="col-lg-5">
        ...
        <div class="form-group">
            <div class=" col-md-12">
              <div class="row">
                <div class="col-md-4 p-0">Payment Referance:</div>
                <div class="col-md-8 p-0">
                  <input type="text" name="payment_ref" class="form-control" value="<?php if(isset($_SESSION['payment_ref'])){ echo $_SESSION['payment_ref']; }?>">
              </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text"  name="other_manufacturer_used" style="height: 100px;" ><?php if(isset($_SESSION['other_manufacturer_used'])){ echo $_SESSION['other_manufacturer_used']; }?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="psl_information" style="height: 100px;" ><?php if(isset($_SESSION['psl_information'])){ echo $_SESSION['psl_information']; }?></textarea>
              </div>
            </div>   
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="competitor_info" style="height: 100px;" ><?php if(isset($_SESSION['competitor_info'])){ echo $_SESSION['competitor_info']; }?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="discount_pricing_info" style="height: 100px;" ><?php if(isset($_SESSION['discount_pricing_info'])){ echo $_SESSION['discount_pricing_info']; }?></textarea>
              </div>
            </div>   
          </div>
      </div> 
