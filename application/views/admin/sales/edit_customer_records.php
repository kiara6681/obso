      ...
      <div class="col-lg-5">
        ...
        <hr><br>
          ...
          <div class="row">
            <div class="col-xl-12 col-sm-6 col-md-12">
              <div class="card" style="background: #222831 !important;padding: 0px;margin-bottom: 0px !important">
                <div class="card-body">
                   ...
                   <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    ...
                    <?php if($customer_record->estimated_frequency == "lessthenoneyear"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="lessthenoneyear" checked="checked" > Less then 1 year
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if($customer_record->estimated_frequency == "daily"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="daily" checked="checked"> Daily
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary ">
                    ...
                    <?php if($customer_record->estimated_frequency == "weekly"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="weekly" checked="checked"> Weekly
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                    ...
                    <?php if($customer_record->estimated_frequency == "monthly"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="monthly" checked="checked"> Monthly
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                    ...
                    <?php if($customer_record->estimated_frequency == "yearly"){ ?>
                       <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="yearly" checked="checked"> Yearly
                      </label>
                    <?php }else{ ?>
                       <label class="btn btn-primary">
                ...
                <div class="card" style="background: #222831 !important;padding: 0px;margin-bottom: 0px !important">
                  <div class="card-body">
                     ...
                     <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      ...
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_spend" value="lessthen50k" checked="checked"> Less then 50k
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if($customer_record->estimated_spend == "50k"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_spend" value="50k" checked="checked"> 50k+
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                    ...
                    <?php } ?>
                     ...
                     <?php if($customer_record->estimated_spend == "100kplus"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_spend" value="100kplus" checked="checked"> 100k+
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                    ...
                    <?php if($customer_record->estimated_spend == "500kplus"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_spend" value="500kplus" checked="checked"> 500k+
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                    ...
                    <?php if($customer_record->estimated_spend == "1mplus"){ ?>
                       <label class="btn btn-primary active">
                          <input type="radio" name="estimated_spend" value="1mplus" checked="checked"> 1m+
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
        ...
        <div class="form-group">
              ...
              <div class="col-md-12" >
                ...
                <input type="text" name="payment_ref" class="form-control" value="<?php echo $customer_record->payment_ref ?>">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text"  name="other_manufacturer_used" style="height: 100px;" ><?php echo $customer_record->other_manufacturer_used; ?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="psl_information" style="height: 100px;" ><?php echo $customer_record->psl_information; ?></textarea>
              </div>
            </div>   
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="competitor_info" style="height: 100px;" ><?php echo $customer_record->competitor_info; ?></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-12">
                <textarea class="form-control" type="text" name="discount_pricing_info" style="height: 100px;" ><?php echo $customer_record->discount_pricing_info; ?></textarea>
              </div>
            </div>   
          </div>
      </div> 
  ...
  <div class="card" style="margin-top: 135px;padding:10px !important">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-sm-6">
              <button type="button" name="cancel" class="btn btn-secondary btn-sm waves-effect waves-light savebtn clr"><a href="<?php echo base_url(); ?>admin/sales/customer_list">Cancel</a></button>
            </div>
            <div class="col-xl-3 col-md-6 col-sm-6">
