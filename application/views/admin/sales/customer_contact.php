        ...
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <?php }else{ ?>
              ...
              ?>
            <a class="nav-link" href="/obsoadmin/admin/sales/edit_customer_recordsone/<?php if(isset($_SESSION['session_id'])) { echo $_SESSION['session_id'];} ?>">
            <?php } } ?>
...
<div class="row">
      ...
      <?php } ?>
        <div class="row" class="cpycls">
          ...
          <div class="col-md-1">
            ...
            <span class="editt"><a href="<?php echo base_url('admin/sales/update_customer_contact/'.$customer_contact['id']) ?>" data-toggle="tooltip"><i class="mdi mdi-square-edit-outline"></i></a></span>
          </div>
          <br>
        </div>
      </div>
  ...
  <div class="col-xl-7 col-md-6 col-sm-6">
    ...
    <div class="row">
      <div class="col-lg-12">
        <form action="<?php echo base_url('admin/sales/add_customer_contact'); ?>" method="POST" enctype="multipart/multipart/form-data">
