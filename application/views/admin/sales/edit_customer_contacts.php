      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <a class="nav-link " href="<?php echo base_url(); ?>admin/sales/edit_customer_records/<?php  echo $customer_record->session_id; ?>">
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link active" href="<?php echo base_url(); ?>admin/sales/edit_customer_contacts/<?php  echo $customer_record->session_id; ?>">
...
<div class="row">
  <div class="col-xl-5 col-md-6 col-sm-6" >
    <div class="card">
      ...
      <div id="myList">
      <?php $i = "1"; foreach ($datas as $customer_contact){ ?>
        ...
        <div class="row" class="cpycls">
          ...
          <div class="col-md-1">
            ...
            <!-- <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
              ...
              <li role="presentation"><a href="<?php echo base_url('admin/sales/markstatus/'.$customer_contact['id']) ?>"><?php if($customer_contact['mark_status'] ==1){ ?>Mark Active <?php }else{ ?> Mark Inactive<?php } ?></a></li>
              <li role="presentation"><a href="<?php echo base_url('admin/sales/delete/'.$customer_contact['id']) ?>" onClick="return doconfirm();" data-toggle="tooltip" data-original-title="Delete">Delete</a></li>
            </ul> -->
            <span class="editt"><a href="<?php echo base_url('admin/sales/update_customer_contacts/'.$customer_contact['id']) ?>" data-toggle="tooltip"><i class="mdi mdi-square-edit-outline"></i></a></span>
          </div>
          <br>
        </div>
      </div>
...
<div class="col-xl-7 col-md-6 col-sm-6">
    ...
    <div class="row">
      <div class="col-lg-12">
        <form action="<?php echo base_url('admin/sales/edit_add_customer_contact'); ?>" method="POST" enctype="multipart/multipart/form-data">
          <input type="hidden" name="session_id" value="<?php echo $customer_record->session_id; ?>">
