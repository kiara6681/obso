                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <?php endif ?>
                                        <form class="" action="<?php echo base_url('admin/industry/add'); ?>" method="POST" enctype="multipart/multipart/form-data">
                                            ...
                                            <div class="form-group mb-0 text-center">
                                                <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />
                                                    ...
                                                    <a href="<?php echo base_url();?>admin/industry/all_industry_list" class="btn btn-secondary waves-effect">
                                                        Cancel
                                                    </a>
                                                    </div>
                                            </div>
