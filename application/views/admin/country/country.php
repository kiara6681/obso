                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">All Country Lists</li>
                            
                        </ol>
                    </div>
                    <div class="col-sm-6 text-right">
                        <button type="button" class="btn btn-primary btn-lg waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg">ADD NEW COUNTRY</button>                                    
                    </div>
                </div>
            </div>
            <!-- end row -->
                                    ...
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if(!empty($manufacturer['flag'])){
                                                        ?>
                                                        <img src="<?= base_url(); ?>uploads/flags/<?= $manufacturer['flag']; ?>" alt="flag" style="width:50px;"> 
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        <a href="#" data-toggle="modal" data-target=".bs-example-modal-lgedit" onclick="get_product_edit(<?php echo $manufacturer['id']; ?>)">
                                                            <i class="fas fa-edit"></i>
                                                        </a> | 
                                                        <a href="<?php echo base_url('admin/country/delete/'.$manufacturer['id']) ?>" onclick="return confirm('Are you sure you want to remove the country list?')" data-toggle="tooltip" data-original-title="Delete" class="far fa-trash-alt"></a>
                                                    </td>                                               
                                            </tr>
                                            <?php $i++; } ?>
        ...
        <div class="modal-body">            
            <div class="modal-body">
             <?php $this->load->helper('form'); ?>
                ...
                <?= form_open(base_url() . 'admin/country/add' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
