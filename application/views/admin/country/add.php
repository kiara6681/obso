                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <?php endif ?>
                                        <form class="" action="<?php echo base_url('admin/country/add'); ?>" method="POST" enctype="multipart/multipart/form-data">
                            ...
                            <div>
                                                    ...
                                                    <a href="<?php echo base_url();?>admin/country/all_country_list" class="btn btn-secondary waves-effect">
                                                        Cancel
                                                    </a>
                                                </div>
                                            </div>
