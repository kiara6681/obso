...
<h5>Edit Contact Information</h5>
    <div class="row">
      <div class="col-lg-12">
        <form action="<?php echo base_url('admin/supplier/update_supplier_contact'); ?>" method="POST" enctype="multipart/multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <input type="number" name="mobile" value="<?php echo $data->mobile; ?>" class="form-control" placeholder="Mobile" />
              </div>
            </div>
            <br>
            <div class="row">
