    ...
    <div class="container-fluid">
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col-sm-6">
            <h3 class="page-title">Sale Database &nbsp>&nbsp supplier Records
            </h3>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                <div class="col-xl-3 col-md-3 col-sm-3 border-rgt">
                  ...
                  <div class="col-xl-12 col-md-12 col-sm-12" style="margin: 16px;"> 
                    <div class="row">
                      <div class="col-xl-12">
                        <h3><input type="text" name="companies" class="form-control" placeholder="Add New Supplier" style="font-size: 20px;text-align: center;"></h3>
                      </div>
                    </div>
                  </div>  
                </div>
...
<h5>Edit Contact Information</h5>
    <div class="row">
      <div class="col-lg-12">
        <form action="<?php echo base_url('admin/supplier/update_supplier_contactone'); ?>" method="POST" enctype="multipart/multipart/form-data">
          <input type="hidden" name="supplier_contact_id" value="<?php echo $data->id; ?>">
          <div class="form-group">
            <div class="row">
              <div class="col-md-6">
                <input type="text" name="fname" value="<?php echo $data->fname; ?>" class="form-control" placeholder="First Name" required/>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <input type="text" name="department" value="<?php echo $data->lname; ?>" class="form-control" placeholder="Department" />
              </div>
            </div>
            <br>
            <div class="row">
              <div class="col-md-6">
                <input type="text" name="job_title" value="<?php echo $data->job_title; ?>" class="form-control" placeholder="Job Title" />
              </div>
              <div class="col-md-6">
                <input type="text" name="branch" value="<?php echo $data->branch; ?>" class="form-control" placeholder="Branch" />
              </div>
            </div>
            <br> 
            <div class="row">
            ...
            <div class="row">
              <div class="col-md-6">
                <input type="number" name="direct_dial" value="<?php echo $data->direct_dial; ?>" class="form-control" placeholder="Direct Dial" />
              </div>
              <!-- <div class="col-md-6">
                <input type="number" name="phone" class="form-control" value="<?php echo $data->phone; ?>" placeholder="Phone Number" />
              </div> -->
            </div>
            <br>
            <div class="row">
              <div class="col-md-12">
                <textarea type="text" name="key_personal_info" class="form-control" placeholder="Key Personal Information" style="height: 150px;" ><?php echo $data->key_personal_info; ?></textarea>
              </div>
            </div>
            <br>
            <div class="row">
              ...
              <div class="col-md-6 text-center">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  <?php if($data->contact_status == "active") { ?>
                      <label class="btn btn-primary ma active">
                          <input type="radio" name="contact_status" value="active"> Active
                      </label>
                  <?php }else{ ?>
                      <label class="btn btn-primary ma">
                          <input type="radio" name="contact_status" value="active"> Active
                  ...
                  <?php if($data->contact_status == "donotcontact") { ?>
                      <label class="btn btn-primary ma active">
                          <input type="radio" name="contact_status" value="donotcontact"> Do Not Contact
                      </label>
                    <?php }else{ ?>
                        <label class="btn btn-primary">
                          <input type="radio" name="contact_status" value="donotcontact"> Do Not Contact
                    ...
                    <?php if($data->contact_status == "inactive") { ?>
                      <label class="btn btn-primary ma active">
                          <input type="radio" name="contact_status" value="inactive"> In-active
                      </label>
                    <?php } else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="contact_status" value="inactive"> In-active
