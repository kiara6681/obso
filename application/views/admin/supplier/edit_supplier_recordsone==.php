            ...
            <div class="row">
             ...
             <div class="btn-group btn-group-toggle" data-toggle="buttons">
              ...
              <?php if($supplier_records->product_condition == "factorysealed"){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="factorysealed" required> Factory Sealed
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if($supplier_records->product_condition == "openbox"){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="openbox" required> Open Box
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if($supplier_records->product_condition == "used"){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="used" required> used Box
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php } ?>
                     ...
                     <?php if($supplier_records->product_condition == "exchange"){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="exchange" required> Exchange
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if($supplier_records->product_condition == "repair"){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="repair" required> Repair
                      </label>
                    <?php }else{ ?>
