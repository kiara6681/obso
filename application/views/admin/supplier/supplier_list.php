      ...
      <?php } ?>
              ...
              <div class="row p-9">
                <div class="col-xl-6 col-md-4 col-sm-6 border-rgt p-top12">
                  ...
                  <div class="col-md-12 m-l-30">
                     <p> 
                      Supplier : <strong style="font-size: 20px;"><a style="color: #000 !important;" href="<?php echo base_url('admin/supplier/edit_supplier_records/'.$supplier_records['session_id']) ?>"><?php echo $supplier_records['company_name']; ?></a></strong><br>
                      Industry : <strong><?php echo $supplier_records['industry_sector']; ?></strong><br>
                      Location :  <strong>Derbyshire</strong><br>
                      Total Spend :  <strong><i class="fas fa-pound-sign" style="color: #000;"></i> 0 (0% anum)</strong><br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        <a role="menuitem" tabindex="-1" href="<?php echo base_url('admin/supplier/edit_supplier_records/'.$supplier_records['session_id']) ?>">
                          <li role="presentation">Edit</li>
                        </a>
                        <!-- <li role="presentation"><a href="#">Copy</a></li> -->
                        <a href="<?php echo base_url('admin/supplier/prospectstatus/'.$supplier_records['id']) ?>">
                          <li role="presentation">Supplier</li>
                        </a>
                        <a href="<?php echo base_url('admin/supplier/partnerstatus/'.$supplier_records['id']) ?>">
                          <li role="presentation">Partner Supplier</li>
                        </a>
                        <a href="<?php echo base_url('admin/supplier/markstatusone/'.$supplier_records['id']) ?>">
                          <li role="presentation"><?php if($supplier_records['mark_status'] ==0){ ?>Mark In Active <?php }else{ ?> Mark Active<?php } ?></li>
                        </a>
                        <a href="<?php echo base_url('admin/supplier/delete_supplier_list/'.$supplier_records['id']) ?>" onclick="return confirm('Are you sure you want to remove the supplier list?')" role="menuitem" tabindex="-1">
                  ...
                  <div class="col-xl-12 col-md-4 col-sm-6 sup-bg p-0">
                    ...
                    <div class="form-group">
                      <select id="ddlCreditCardType" name="ddlCreditCardType" class="form-control">
                        ...
                        <option value="allcustomer">All Suppliers</option>
                        <option value="singleordercustomer">Single Order Suppliers</option>
                        <option value="repeatcustomer">Repeat Suppliers 2-9</option>
                        <option value="ordercustomer">10-99 Order Suppliers</option>
                        <option value="hundredordercustomer">100+ Order Suppliers</option> 
                        <option value="accountcustomer">Account Suppliers</option>
        ...
        <div class="button-wrap">
          ...
          <label class="button-label" for="van-button" style="width: 100%;">
            <h1>Current Year Spend <strong><i class="fas fa-pound-sign"></i> 500,00</h1>
          </label>
          </div>
