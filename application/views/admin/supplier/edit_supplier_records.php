...
<!-- end row -->
<form action="<?php echo base_url('admin/supplier/edit_supplier_records'); ?>" method="POST" enctype="multipart/multipart/form-data">
<div class="row">
...
<div class="row line_height_25">
  ...
  <div class="col-xl-3 col-md-3 col-sm-3 border-rgt">
    ...
    <div class="col-xl-12 col-md-12 col-sm-12" style="margin: 16px;"> 
      <div class="row">
        <div class="col-xl-12">
          <h3><input type="text" name="company_name" class="form-control addnewcompny" placeholder="Add New Supplier" required value="<?php echo $supplier_records->company_name; ?>"></h3>
        </div>
      </div>
    </div>  
  </div>
...
<div class="col-xl-3 col-md-4 col-sm-6 border-rgt">
    <div class="col-xl-12 col-md-4 col-sm-6 m-t-5" style="padding: 0px;">
      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link active" href="<?php echo base_url(); ?>admin/sales/supplier_records/<?php  echo $supplier_records->session_id; ?>">
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link" href="<?php echo base_url(); ?>admin/supplier/edit_supplier_contacts/<?php  echo $supplier_records->session_id; ?>">
                   ...
                   <div class="btn-group btn-group-toggle" data-toggle="buttons">
                     ...
                     <?php if($supplier_records->estimated_frequency == "sameday"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="sameday" required="required" checked="checked"> Same Day
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="estimated_frequency" value="sameday"  required="required"> Same Day
                      </label>
                    <?php } ?>

                    <?php if($supplier_records->estimated_frequency == "pre9am"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="pre9am"  required="required" checked="checked"> Pre 9am
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="estimated_frequency" value="pre9am"  required="required"> Pre 9am
                      </label>
                    <?php } ?>

                    <?php if($supplier_records->estimated_frequency == "nextday"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="nextday" required checked="checked"> Next Day
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="estimated_frequency" value="nextday"  required="required"> Next Day
                      </label>
                    <?php } ?>

                    <?php if($supplier_records->estimated_frequency == "2days"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="2days"  required="required" checked="checked"> 2 days
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="estimated_frequency" value="2days"  required="required"> 2 days
                      </label>
                    <?php } ?>
                    ...
                    <?php if($supplier_records->estimated_frequency == "longer"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="estimated_frequency" value="longer"  required="required" checked="checked"> Longer
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="estimated_frequency" value="longer" required="required"> Longer
                      </label>
                    <?php } ?>
                ...
                <div class="card" style="background: #222831 !important;">
                  <div class="card-body">
                     ...
                     <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      ...
                      <label class="btn btn-primary active">
                          <input type="radio" name="standard_delivery" value="lessthen50k" required="required" checked="checked"> less then 50k
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="standard_delivery" value="lessthen50k" required="required"> less then 50k
                      </label>
                    <?php } ?>

                    <?php if($supplier_records->standard_delivery == "2days"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="standard_delivery" value="2days" required="required" checked="checked">  2 Days
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="standard_delivery" value="2days" required="required">  2 Days
                      </label>
                    <?php } ?>
                    ...
                    <?php if($supplier_records->standard_delivery == "35days"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="standard_delivery" value="35days" required="required" checked="checked">  3-5 Days
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="standard_delivery" value="35days" required="required">  3-5 Days
                      </label>
                    <?php } ?>
                     ...
                     <?php if($supplier_records->standard_delivery == "57days"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="standard_delivery" value="57days" required="required" checked="checked">  5 7 days
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="standard_delivery" value="57days" required="required">  5 7 days
                      </label>
                    <?php } ?>
                     ...
                     <?php if($supplier_records->standard_delivery == "longer"){ ?>
                      <label class="btn btn-primary active">
                          <input type="radio" name="standard_delivery" value="longer" required="required" checked="checked">  Longer
                      </label>
                    <?php }else{ ?>
                      <label class="btn btn-primary">
                          <input type="radio" name="standard_delivery" value="longer" required="required">  Longer
                      </label>
                    <?php } ?>
        ...
        <br>
          ...
          <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-xl-12 col-sm-6 col-md-12">
                        <div class="card" style="background: #222831 !important;">
                          ...
                          <div class="card-body">
                              <?php $chkbox=$supplier_records->manufacturer_use;
                                $arr=explode(",",$chkbox);
                              ?>
                              <?php foreach ($manufacturer as $manufacturer){ ?>
                                ...
                                <label class="btn btn-primary <?php if(in_array($manufacturer['manufacturer'],$arr)){ ?>active <?php } ?>">
            ...
            <div class="row">
              ...
              <div class="col-md-6" >
                <input type="text" name="other_manufacturer" class="form-control" value="<?php echo $supplier_records->other_manufacturer; ?>" required>
              </div>
            </div>
          </div>
            ...
            <div class="row">
             ...
             <div class="btn-group btn-group-toggle" data-toggle="buttons">
              <?php if(strpos($supplier_records->product_condition, "factorysealed") !==false){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="factorysealed" checked="checked"> Factory Sealed
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if(strpos($supplier_records->product_condition, "openbox") !==false){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="openbox" checked="checked"> Open Box
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if(strpos($supplier_records->product_condition, "used") !==false){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="used" checked="checked"> used Box
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php } ?>
                     ...
                     <?php if(strpos($supplier_records->product_condition, "exchange") !==false){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="exchange" checked="checked"> Exchange
                      </label>
                    <?php }else{ ?>
                   ...
                   <?php if(strpos($supplier_records->product_condition, "repair") !==false){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="product_condition[]" value="repair" checked="checked"> Repair
                      </label>
                    <?php }else{ ?>
             ...
             <?php if(strpos($supplier_records->lifecycle_status, "currentline") !==false){ ?>

                      <label class="btn btn-primary active">
                          <input type="checkbox" name="lifecycle_status[]" value="currentline"  checked="checked"> Current Line
                      </label>
                    <?php }else{ ?>
                   ...
                   <?php if(strpos($supplier_records->lifecycle_status, "phaseout") !==false){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="lifecycle_status[]" value="phaseout"  checked="checked"> Phase Out
                      </label>
                    <?php }else{ ?>
                    ...
                    <?php if(strpos($supplier_records->lifecycle_status, "obsolete") !==false){ ?>
                      <label class="btn btn-primary active">
                          <input type="checkbox" name="lifecycle_status[]" value="obsolete" checked="checked" > Obsolete 
                      </label>
                    <?php }else{ ?>
  ...
  <div class="card" style="margin-top: 135px;padding:10px !important">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-sm-6">
              <button type="button" name="cancel" class="btn btn-secondary btn-sm waves-effect waves-light savebtn clr"><a href="<?php echo base_url(); ?>admin/supplier/supplier_list">Cancel</a></button>
            </div>
            <div class="col-xl-3 col-md-6 col-sm-6">
