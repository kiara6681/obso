                          ...
                          <div class="col-xl-3 col-md-3 col-sm-3 border-rgt">
                            <i class="ion ion-md-globe earth earth-position"></i>
                              ...
                              <div class="col-xl-12 col-md-12 col-sm-12" style="margin: 16px;"> 
                                <div class="row">
                                  <div class="col-xl-12">
                                    <h3><input type="text" name="companies" class="form-control addnewcompny" placeholder="Add New Supplier" style="font-size: 20px;text-align: center;" value="<?php if(isset($_SESSION['company_name'])){ echo $_SESSION['company_name']; }?>"></h3>
                                  </div>
                                  </div>
    ...
    <ul class="nav nav-pills nav-justified" role="tablist">
      <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <?php }else{ ?>
              ...
              ?>
            <a class="nav-link" href="/obsoadmin/admin/supplier/edit_supplier_recordsone/<?php if(isset($_SESSION['session_id'])) { echo $_SESSION['session_id'];} ?>">
            <?php } } ?>
        ...
        <div class="row" class="cpycls">
          ...
          <div class="col-md-1">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
              ...
              <li role="presentation"><a href="<?php echo base_url('admin/supplier/delete/'.$supplier_contact['id']) ?>" onclick="return confirm('Are you sure you want to remove the contact list?')" data-toggle="tooltip" data-original-title="Delete">Delete</a></li>
            </ul>
