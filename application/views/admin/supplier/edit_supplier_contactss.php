              ...
              <div class="row">
                <div class="col-xl-3 col-md-3 col-sm-3 border-rgt">
                  ...
                  <div class="col-xl-12 col-md-12 col-sm-12" style="margin: 16px;"> 
                    <div class="row">
                      <div class="col-xl-12">
                        <h3><input type="text" name="companies" class="form-control addnewcompny" placeholder="Add New Supplier" value="<?php if(isset($_SESSION['company_name'])){ echo $_SESSION['company_name']; }?>"></h3>
                      </div>
                    </div>
                  </div>  
                </div>
...
<h5>Edit Contact Information</h5>
    <div class="row">
      <div class="col-lg-12">
        <form action="<?php echo base_url('admin/supplier/update_supplier_contacts'); ?>" method="POST" enctype="multipart/multipart/form-data">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name="session_id" value="<?php echo $data->session_id; ?>" class="form-control" placeholder="Last Name" required/>
              </div>
            </div>
            <br>
            <div class="row">
              ...
              <div class="col-md-6">
                <input type="text" name="department" value="<?php echo $data->department; ?>" class="form-control" placeholder="Department" />
              </div>
            </div>
            <br>
            <div class="row">
