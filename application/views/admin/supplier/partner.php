        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-justified" role="tablist">
            ...
            <li class="nav-item waves-effect waves-light">
              ...
              <a class="nav-link prospect" data-toggle="tab" href="<?php echo base_url(); ?>admin/supplier/prospects" role="tab">
                 <?php }else{ ?>
            ...
            <li class="nav-item waves-effect waves-light">
              ...
              <a class="nav-link account" data-toggle="tab" href="<?php echo base_url(); ?>admin/supplier/partner" role="tab">
                 <?php }else{ ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-2">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <!-- <li role="presentation"><a href="<?//php echo base_url('admin/supplier/suspectstatus/'.$supplier_records['id']) ?>">Potential Supplier</a></li>
                        <li role="presentation"><a href="<?//php echo base_url('admin/supplier/partnersupplier/'.$supplier_records['id']) ?>">Partner Supplier</a></li> -->
                        ...
                        <a href="<?php echo base_url('admin/supplier/delete_supplier_list/'.$supplier_records['id']) ?>" onClick="return doconfirm();" role="menuitem" tabindex="-1">
