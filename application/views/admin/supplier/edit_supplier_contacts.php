    ...
    <div class="container-fluid">
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col-sm-6">
            <h3 class="page-title"><b>Supplier Database</b> &nbsp>&nbsp Supplier Records
            </h3>
          </div>
        </div>
      </div>
              ...
              <div class="row line_height_25">
                <div class="col-xl-3 col-md-3 col-sm-3 border-rgt">
                  ...
                  <div class="col-xl-12 col-md-12 col-sm-12" style="margin: 16px;"> 
                    <div class="row">
                      <div class="col-xl-12">
                      <p><input type="text" name="company_name" class="form-control addnewcompny" placeholder="Add New Supplier" style="font-size: 20px;text-align: center;" required value="<?php echo $supplier_record->company_name; ?>"></p>
                      </div>
                    </div>
                  </div>  
                </div>
                <div class="col-xl-3 col-md-4 col-sm-6 border-rgt">
                  <div class="col-xl-12 col-md-4 col-sm-6 m-t-5">
                    <input type="hidden" name="session_id" value="<?php echo $supplier_record->session_id; ?>">
                    <strong>   Trader Name : <select name="trader_name" class="form-control record trad">
                      <option value="<?php echo $supplier_record->trader_name; ?>"><?php echo $supplier_record->trader_name; ?></option>
                    </select>
                  </strong><br>
                  <strong>  Contact Date : <?php  echo date('d/m/Y', strtotime($supplier_record->creation_date)); ?></strong><br>
      ...
      <div class="card-body">
        <ul class="nav nav-pills nav-justified" role="tablist">
          <li class="nav-item waves-effect waves-light border-rgt">
            ...
            <a class="nav-link " href="<?php echo base_url(); ?>admin/supplier/edit_supplier_records/<?php  echo $supplier_record->session_id; ?>">
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link active" href="<?php echo base_url(); ?>admin/supplier/edit_supplier_contacts/<?php  echo $supplier_record->session_id; ?>">
          ...
          <li class="nav-item waves-effect waves-light border-rgt">
            <a class="nav-link" data-toggle="tab" href="#supplierummery" role="tab">
              <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
...
<div class="row">
  <div class="col-xl-5 col-md-5 col-sm-6" >
    <div class="card">
      ...
      <div id="myList">
      <?php $i = "1"; foreach ($datas as $supplier_contact){ ?>

          <?php if($supplier_contact['contact_status'] ==1){ ?>
      <div class="form-control sellerlistbgclr" style="border-style: solid; border-color: #ff0000">
      <?php } ?>
      <?php if($supplier_contact['contact_status'] ==0){ ?>
      ...
      <?php } ?>
        <div class="row" class="cpycls">
          ...
          <div class="col-md-10" id="cpyid<?php echo $i; ?>">
            <div class="row">
              <div class="f-sz col-md-12 col-xl-12 col-sm-6 myvpy"><?php echo $supplier_contact['fname']; ?> <?php echo $supplier_contact['lname']; ?> | <?php echo $supplier_contact['department']; ?> | <?php echo $supplier_contact['branch']; ?></div>
            </div><br>
          ...
          <div class="col-md-1">
            ...
            <!-- <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
              ...
              <li role="presentation"><a href="<?php echo base_url('admin/supplier/markstatus/'.$supplier_contact['id']) ?>"><?php if($supplier_contact['mark_status'] ==1){ ?>Mark Active <?php }else{ ?> Mark Inactive<?php } ?></a></li>
            ...
            <span class="editt"><a href="<?php echo base_url('admin/supplier/update_supplier_contacts/'.$supplier_contact['id']) ?>" data-toggle="tooltip"><i class="mdi mdi-square-edit-outline"></i></a></span>
          </div>
          <br>
        </div>
      </div>
  ...
  <div class="col-xl-7 col-md-6 col-sm-6">
    ...
    <div class="row">
      <div class="col-lg-12">
        <form action="<?php echo base_url('admin/supplier/add_edit_supplier_contact'); ?>" method="POST" enctype="multipart/multipart/form-data">
          <input type="hidden" name="session_id" value="<?php echo $supplier_record->session_id; ?>">
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-6">
                <input type="number" name="direct_dial" class="form-control" placeholder="Direct Dial" />
              </div>
             <!--  <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                <textarea type="text" name="key_personal_info" class="form-control" placeholder="Key Personal Information" style="height: 150px;" ></textarea>
              </div>
            </div>
            <br>
            <div class="row">
              <div class="col-md-6 text-center">
                 ...
                 <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <label class="btn btn-primary">
                          <input type="radio" name="mkt_preferance" value="use_email" checked="checked"> Use Email
                      </label>
                      <label class="btn btn-primary">
              ...
              <div class="col-md-6 text-center">
                ...
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                      <label class="btn btn-primary">
                          <input type="radio" name="markstatus" value="0" checked="checked"> Active
                      </label>
                      <label class="btn btn-primary">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <input type="text"   class="form-control"   placeholder="Contact E-mail"/>
            </div>
          </div>
          <br>
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <select id="" name="" class="form-control">
                  <option value="">Permission access: supplier</option>
                  <option value="AE">abc</option>
                  <option value="VI">abc</option>
                  <option value="OT">abc</option>
                </select>
