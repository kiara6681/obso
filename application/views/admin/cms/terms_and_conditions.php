  ...
  <div class="content">
    <div class="container-fluid">
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col-sm-12">
            <h3 class="page-title"><b>Terms and Conditions</b><hr>
            </h3>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-7">
        ...
        <form action="<?php echo base_url('admin/cms/edit_terms_and_conditions'); ?>" method="POST" enctype="multipart/multipart/form-data">
       
          <div class="form-group">
            <div class="row">
               <div class="col-md-12">
                <label>Description</label>
                <textarea type="text" name="description" class="form-control" style="height: 300px;"><?php echo $data->description; ?></textarea>
              </div>
