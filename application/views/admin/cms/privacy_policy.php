  ...
  <div class="content">
    <div class="container-fluid">
      <div class="page-title-box">
        <div class="row align-items-center">
          <div class="col-sm-12">
            <h3 class="page-title"><b>Privacy Policy</b><hr>
            </h3>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-7">
        ...
        <form action="<?php echo base_url('admin/cms/edit_privacy_policy'); ?>" method="POST" enctype="multipart/multipart/form-data">
