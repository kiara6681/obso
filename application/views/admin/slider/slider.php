                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">All Slider Lists</li>
                                    ...
                                    <div class="card-body">
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th><?php echo $slider['description']; ?></th>
                                                <td>
                                      <img src="<?php echo base_url(); ?>uploads/<?php echo $slider['image']; ?>" height="50px" weight="50px"/>
                                   </td>
                                                ...
                                                <td><a href="#" data-toggle="modal" data-target=".bs-example-modal-lgedit" onclick="get_product_edit(<?php echo $slider['id']; ?>)"><i class="fas fa-edit"></i></a>  
                                                   <!--  <a href="<?php echo base_url('admin/slider/delete/'.$slider['id']) ?>" onclick="return confirm('Are you sure you want to remove the contact list?')" data-toggle="tooltip" data-original-title="Delete" class="far fa-trash-alt"></a> --></td>
...
<div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title mt-0" id="myLargeModalLabel">ADD NEW SLIDER</h5>
        ...
        <div class="modal-body">
                ...
                <div class="modal-body">
                 ...
                 <?php $this->load->helper('form'); ?>
                    ...
                    <?php echo form_open(base_url() . 'admin/slider/add' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                <textarea type="text" name="description" class="form-control" required placeholder="Type something"/></textarea>
                                                </div>
                                            </div>
