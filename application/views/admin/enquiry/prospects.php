        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-justified" role="tablist">
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
              ...
              <a class="nav-link suspect" data-toggle="tab" href="<?php echo base_url(); ?>admin/enquiry/prospects" role="tab">
                <?php }else{ ?>
            ...
            <li class="nav-item waves-effect waves-light border-rgt">
              ...
              <a class="nav-link" data-toggle="tab" href="<?php echo base_url(); ?>admin/enquiry/partner" role="tab">
                <?php }else{ ?>
                ...
                <div class="card-body">
                  ...
                  <div class="col-xl-12 col-md-4 col-sm-6 sup-bg p-0">
                    <div class="form-group text-center">
                      ...
                      <button type="button" class="btn btn-primary btn-lg btn-block waves-effect waves-light" style="color: #0cff0c;">Enquiry Todays (<?php  echo $quoted; ?>)</button>
                    ...
                    <div class="form-group text-center">
                      ...
                      <button type="button" class="btn btn-primary btn-lg btn-block waves-effect waves-light" style="color: red;">Outstanding (<?php  echo $quoted; ?>)</button>
