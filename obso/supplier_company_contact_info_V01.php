                  ...
                  <div class="card-body">
                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-3 col-md-4 col-sm-6 border-rgt">
                            <div class="col-xl-12 col-md-4 col-sm-6 m-t-5">
                                   <span>
                              Recorded by : <select id="ddlCreditCardType" name="ddlCreditCardType" class="form-control" style="width: 60%;float: right;height: 29px;border-radius:0px !important;background: #36394c !important;">
                          ...
                          <div class="col-xl-2 col-md-4 col-sm-6 border-rgt">
                           ...
                           <div class="col-xl-2 col-md-4 col-sm-6">
                              <div class="row row-width" >
                                ...
                                <div class="col-xl-12 col-md-4 col-sm-6"><input type="hidden" class="rating" data-filled="mdi mdi-star text-primary" data-empty="mdi mdi-star-outline text-primary" data-fractions="2"/><br>
