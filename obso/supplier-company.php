...
/*Virendra*/
.btn-primary:hover {
    background: rgb(233, 101, 90) !important;
    color: #000 !important;
    border: 1px solid rgb(233, 101, 90) !important;
}
.btn-primary.focus, .btn-primary:focus, .btn-outline-primary.focus, .btn-outline-primary:focus, .btn-primary:not(:disabled):not(.disabled).active:focus, .btn-primary:not(:disabled):not(.disabled):active:focus, .show > .btn-primary.dropdown-toggle:focus, .btn-outline-primary:not(:disabled):not(.disabled).active:focus, .btn-outline-primary:not(:disabled):not(.disabled):active:focus, .show > .btn-outline-primary.dropdown-toggle:focus {
    ...
    box-shadow: 0 0 0 2px rgb(233, 101, 90);
    background: rgb(233, 101, 90) !important;
}
.btn-primary {
...
.newsuppliername{
  ...
  border-color: rgb(8, 73, 97) !important;
}
.btn-outline-primary {
    color: #ffffff;
    border-color: #17384b;
...
.listbg{
  margin-top: 5px;height: 150px;margin-bottom: 5px;font-weight: bold;font-size: 12px;background: #17384b !important;
}
.btn-primary {
    background-color: #3936df;
    border: 1px solid #3936df;
}
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                     <h3 class="page-title">Supplier Database &nbsp>&nbsp Supplier Company
                            ...
                            <div class="col-lg-5">
                              ...
                              <form class="" action="#">
                                ...
                                <div class="form-group">
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      placeholder="Supplier Type Free Text" style="border-radius: 5px;"/>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="row">
                                    <div class="col-md-12">
                                      ...
                                      placeholder="Website Address of main supplier site" style="border-radius: 5px;"/>
                                    </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="col-md-12">
                                      <select id="ddlCreditCardType" name="ddlCreditCardType" class="form-control" style="border-radius: 5px;">
                                        <option value="">Supplier Record Source</option>
                                        <option value="AE">ABC</option>
                                        <option value="VI">ABC</option>
                                        <option value="MC">ABC</option>
                                        <option value="DI">ABC</option>
                                ...
                                <h4 class="mt-0 header-title">Delivery Information</h4>
                                <hr>
                                <br>

  <p class="mt-0 header-title">Express Delivery lead time<small>(Options Available):</small></p>
    <style type="text/css">
...
.btn-primary {
   ...
   <!--      <div class="button-wrap"> 
    ...
    <div class="form-group">
      <p class="mt-0 header-title">Standard Delivery lead time<small>(Options Available):</small> </p>
            ...
            <div class="button-items">
              ...
              <button type="button" class="btn btn-primary waves-effect waves-light">Yearly</button>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                                <label for="example-datetime-local-input" class="col-sm-4 col-form-label">Order cut off needs</label>
                                                <div class="col-sm-8">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <option value="AE">Choose Time Zone</option>
                                      <option value="VI">ABC</option>
                                      <option value="MC">ABC</option>
                                      <option value="DI">ABC</option>
                                    </select>
                                    ...
                                    <div class="col-md-12" style="border-radius: 5px;">
                                      ...
                                      <textarea type="text" name=""class="form-control" required placeholder="Order Cut off & Delivery Information" style="border-radius: 5px;height: 300px;"></textarea>
                      ...
                      <div class="form-group">
                                  ...
                                  <p class="mt-0 header-title">Payment Information:</small> </p>
                                    ...
                                    <div class="col-md-12 p-0">
                                      ...
                                      <option value="AE">Payment Terms: Select Option</option>
                                      <option value="VI">ABC</option>
                                      <option value="MC">ABC</option>
                                      <option value="DI">ABC</option>
                                    </select>
                                    ...
                                    <div class="col-md-12 p-0" style="border-radius: 5px;">
                                      
                                      
                                      <input type="text" name=""class="form-control" required placeholder="Payment Reference: | cocacola123456 " style="border-radius: 5px;">
...
<br>
                                    <div class="col-md-12 p-0" style="border-radius: 5px;">
                                      ...
                                      <textarea type="text" name=""class="form-control" required placeholder="Discount & Pricing Information " style="border-radius: 5px;height: 300px;"></textarea>
      ...
      <div class="form-group">
                                    ...
                                    <div class="col-md-12 p-0" style="border-radius: 5px;">
                                      ...
                                      <textarea type="text" name=""class="form-control" required placeholder="Other Manufacturers Supplied" style="border-radius: 5px;height: 300px;"></textarea>  
      ...
      <div class="col-xl-12 col-sm-6 col-md-12">
        <div class="card" style="background: #222831 !important;">
          ...
          <div>
            ...
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="1" >Factory Sealed</button>
          </div>
          <div>
            <input type="checkbox" class="reffer-check" name="hearFrom" value="2" />
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="2" >Open Box</button>
          </div>
          
          <div>
            <input type="checkbox" class="reffer-check" name="hearFrom" value="3" />
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="3" >Used</button>
          </div>
          <div>
            <input type="checkbox" class="reffer-check" name="hearFrom" value="4" />
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="4" >Exchange</button>
          </div>
          <div>
            <input type="checkbox" class="reffer-check" name="hearFrom" value="5" />  
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="5" >Repair</button>
          </div>
          </div> -->
       ...
       <div class="form-group">
         <div class="row">
          ...
          <div>
            <input type="checkbox" class="reffer-check" name="hearFrom" value="1" />
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="1" >Catalogue /Current Line</button>
          </div>
          <div>
            <input type="checkbox" class="reffer-check" name="hearFrom" value="2" />
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="2" >Phase Out</button>
          </div>
          
          <div>
            <input type="checkbox" class="reffer-check" name="hearFrom" value="3" />
            <button type="button" class="btn btn-outline-primary theme_btn bgclr btnwdt" data-id="3" >Obsolete</button>
          </div>
                              ...
                              <form action="#">
                                ...
                                <div class="form-group">
                                  ...
                                  <br>
                                   ...
                                   <button type="button" class="btn btn-secondary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-center"><i class="fa fa-map-marker"></i>&nbsp&nbsp Add new Address</button>
